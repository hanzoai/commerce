export const effects = {
  "dark": {
    "--details-contrast-on-bg-interactive": "0px 1px 2px 0px rgba(153, 27, 27, 0.6)",
    ...
    "--borders-interactive-with-active": "0px 0px 0px 1px rgba(253, 114, 114, 1), 0px 0px 0px 4px rgba(253, 68, 68, 0.25)",
    "--borders-focus": "0px 0px 0px 1px rgba(24, 24, 27, 1), 0px 0px 0px 3px rgba(253, 114, 114, 0.8)",
    "--details-switch-background-focus": "0px 0px 0px 1px rgba(24, 24, 27, 1), 0px 0px 0px 3px rgba(253, 114, 114, 0.8), 0px 1px 1px 0px rgba(0, 0, 0, 0.1) inset, 0px 2px 4px 0px rgba(0, 0, 0, 0.1) inset, 0px 0px 0px 0.75px rgba(255, 255, 255, 0.12) inset, 0px 0px 8px 0px rgba(0, 0, 0, 0.1) inset",
    ...
    "--buttons-danger-focus": "0px -1px 0px 0px rgba(255, 255, 255, 0.16), 0px 0px 0px 1px rgba(255, 255, 255, 0.12), 0px 0px 0px 1px rgba(159, 18, 57, 1), 0px 0px 0px 2px rgba(24, 24, 27, 1), 0px 0px 0px 4px rgba(253, 114, 114, 0.8)",
    ...
    "--buttons-inverted-focus": "0px -1px 0px 0px rgba(255, 255, 255, 0.12), 0px 0px 0px 1px rgba(255, 255, 255, 0.12), 0px 0px 0px 1px rgba(82, 82, 91, 1), 0px 0px 0px 2px rgba(24, 24, 27, 1), 0px 0px 0px 4px rgba(253, 114, 114, 0.8)",
    ...
    "--buttons-neutral-focus": "0px -1px 0px 0px rgba(255, 255, 255, 0.06), 0px 0px 0px 1px rgba(255, 255, 255, 0.06), 0px 0px 0px 1px rgba(39, 39, 42, 1), 0px 0px 0px 2px rgba(24, 24, 27, 1), 0px 0px 0px 4px rgba(253, 114, 114, 0.8)",
    ...
    "--borders-interactive-with-focus": "0px -1px 2px 0px rgba(254, 226, 226, 0.5), 0px 0px 0px 1px rgba(253, 114, 114, 1), 0px 0px 0px 2px rgba(24, 24, 27, 1), 0px 0px 0px 4px rgba(253, 114, 114, 0.8)",
    "--borders-interactive-with-shadow": "0px -1px 2px 0px rgba(254, 226, 226, 0.5), 0px 0px 0px 1px rgba(253, 114, 114, 1)"
  },
  "light": {
    "--buttons-danger-focus": "0px 0.75px 0px 0px rgba(255, 255, 255, 0.2) inset, 0px 1px 2px 0px rgba(190, 18, 60, 0.4), 0px 0px 0px 1px rgba(190, 18, 60, 1), 0px 0px 0px 2px rgba(255, 255, 255, 1), 0px 0px 0px 4px rgba(253, 68, 68, 0.6)",
    "--details-contrast-on-bg-interactive": "0px 1px 2px 0px rgba(153, 27, 27, 0.6)",
    "--borders-error": "0px 0px 0px 1px rgba(225, 29, 72, 1), 0px 0px 0px 3px rgba(225, 29, 72, 0.15)",
    "--borders-focus": "0px 0px 0px 1px rgba(255, 255, 255, 1), 0px 0px 0px 3px rgba(253, 68, 68, 0.6)",
    ...
    "--buttons-inverted-focus": "0px 0.75px 0px 0px rgba(255, 255, 255, 0.2) inset, 0px 1px 2px 0px rgba(0, 0, 0, 0.4), 0px 0px 0px 1px rgba(24, 24, 27, 1), 0px 0px 0px 2px rgba(255, 255, 255, 1), 0px 0px 0px 4px rgba(253, 68, 68, 0.6)",
    ...
    "--buttons-neutral-focus": "0px 1px 2px 0px rgba(0, 0, 0, 0.12), 0px 0px 0px 1px rgba(0, 0, 0, 0.08), 0px 0px 0px 2px rgba(255, 255, 255, 1), 0px 0px 0px 4px rgba(253, 68, 68, 0.6)",
    "--details-switch-background-focus": "0px 0px 0px 1px rgba(255, 255, 255, 1), 0px 0px 0px 3px rgba(253, 68, 68, 0.6), 0px 1px 1px 0px rgba(0, 0, 0, 0.04) inset, 0px 2px 4px 0px rgba(0, 0, 0, 0.04) inset, 0px 0px 0px 0.75px rgba(0, 0, 0, 0.06) inset, 0px 0px 8px 0px rgba(0, 0, 0, 0.02) inset, 0px 2px 4px 0px rgba(0, 0, 0, 0.04)",
    ...
    "--borders-interactive-with-focus": "0px 1px 2px 0px rgba(153, 27, 27, 0.5), 0px 0px 0px 1px rgba(220, 38, 38, 1), 0px 0px 0px 2px rgba(255, 255, 255, 1), 0px 0px 0px 4px rgba(220, 38, 38, 0.6)",
    "--borders-interactive-with-shadow": "0px 1px 2px 0px rgba(153, 27, 27, 0.5), 0px 0px 0px 1px rgba(220, 38, 38, 1)",
    "--borders-interactive-with-active": "0px 0px 0px 4px rgba(220, 38, 38, 0.2), 0px 0px 0px 1px rgba(220, 38, 38, 1)"
  }
}
