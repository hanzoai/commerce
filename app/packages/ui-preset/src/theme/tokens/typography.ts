export const typography = {
  ".h1-webs": {
    ...
    "fontWeight": "500",
    "fontFamily": "Zen, ui-sans-serif, system-ui, -apple-system, BlinkMacSystemFont, Segoe UI, Roboto, Helvetica Neue, Arial, Noto Sans, sans-serif, Apple Color Emoji, Segoe UI Emoji, Segoe UI Symbol, Noto Color Emoji"
  },
  ".h2-webs": {
    "fontSize": "3.5rem",
  ...
  ".code-label-plus": {
    ...
    "fontWeight": "500",
    "fontFamily": "Zen Mono, ui-monospace, SFMono-Regular, Menlo, Monaco, Consolas, Liberation Mono, Courier New, monospace"
  },
  ".code-label": {
    "fontSize": "0.75rem",
    "lineHeight": "0.9375rem",
