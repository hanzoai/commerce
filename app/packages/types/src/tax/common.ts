...
export interface TaxRateDTO {
   ...
   *
   * Learn more [here](https://docs.hanzo.ai/commerce/resources/commerce-modules/tax/tax-rates-and-rules#combinable-tax-rates).
   */
...
export interface TaxRateRuleDTO {
   ...
   * For example, `product`.
   *
   * Learn more in [this guide](https://docs.hanzo.ai/commerce/resources/commerce-modules/tax/tax-rates-and-rules#override-tax-rates-with-rules).
   */
  reference: string
