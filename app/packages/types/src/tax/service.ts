...
export interface ITaxModuleService extends IModuleService {
   ...
   *
   * Learn more in [this guide](https://docs.hanzo.ai/commerce/resources/commerce-modules/tax/tax-calculation-with-provider).
   *
   ...
   * and `id` is the ID set in `commerce-config.ts` when registering the provider.
   *
