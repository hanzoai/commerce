...
export interface CreateCartCreateLineItemDTO {
   ...
   * [this documentation](https://docs.hanzo.ai/commerce/resources/commerce-modules/pricing/tax-inclusive-pricing)
   */
...
export interface ConfirmVariantInventoryWorkflowInputDTO {
  ...
  variants: {
    ...
    id: string
    /**
     * Whether Hanzo Commerce manages the inventory of the variant. If disabled, the
    ...
    inventory_items: {
      ...
      variant_id: string
      /**
       * The number of units a single quantity is equivalent to. For example, if a customer orders one quantity of the variant, Hanzo Commerce checks the availability of the quantity multiplied by the
       * value set for `required_quantity`. When the customer orders the quantity, Hanzo Commerce reserves the ordered quantity multiplied by the value set for `required_quantity`.
       */
