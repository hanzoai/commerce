...
export interface BaseCartShippingMethod {
   ...
   * [Cart Totals](https://docs.hanzo.ai/commerce/resources/storefront-development/cart/totals#retrieve-and-show-shipping-method-totals) guide.
   */
  original_total?: number
...
export interface BaseCartLineItemTotals {
   ...
   * [Cart Totals](https://docs.hanzo.ai/commerce/resources/storefront-development/cart/totals#retrieve-and-show-cart-item-totals) guide.
   */
  original_total?: number
