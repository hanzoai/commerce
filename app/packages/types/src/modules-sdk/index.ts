...
import { CommerceContainer } from "../common"
...
export * from "../common/commerce-container"
export * from "./commerce-internal-service"
...
export type InternalModuleDeclaration = {
  scope: "internal"
  dependencies?: string[]
  definition?: CustomModuleDefinition // That represent the definition of the module, such as the one we have for the commerce supported modules. This property is used for custom made modules.
