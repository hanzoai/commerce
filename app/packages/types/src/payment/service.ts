...
export interface IPaymentModuleService extends IModuleService {
   ...
   * from other modules, use [Query](https://docs.hanzo.ai/commerce/learn/fundamentals/module-links/query) instead.
   * 
   * :::
   *
   * ```ts
   ...
   *
   * Learn more about the payment flow in [this guide](https://docs.hanzo.ai/commerce/resources/commerce-modules/payment/payment-flow)
   *
   ...
   *
   * Learn more about handling webhook events in [this guide](https://docs.hanzo.ai/commerce/resources/commerce-modules/payment/webhook-events)
   *
   ...
   *
   * @example
   * In the following example, `req` is an instance of `CommerceRequest`:
   *
   * ```ts
