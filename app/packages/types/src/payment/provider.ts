...
export type PaymentCustomerDTO = {
  /**
   * The ID of the customer in Hanzo Commerce.
   */
  id: string
  /**
...
export type PaymentProviderContext = {
  ...
  /**
   * The customer information from Hanzo Commerce.
   */
 ...
 * property is stored as-is in Hanzo Commerce's account holder's `data` property.
 */
...
export interface CreateAccountHolderOutput extends PaymentProviderOutput {
  /**
   * The ID of the account holder in the payment provider.
   * This is stored in Hanzo Commerce's account holder in the `external_id` property.
   */
  id: string
}
...
export type WebhookActionData = {
  /**
   * The ID of the payment session in Hanzo Commerce.
...
export type WebhookActionResult = {
  /**
   * The action that was performed so that Hanzo Commerce can handle it internally.
   */
...
export interface IPaymentProvider {
  ...
  /**
   * This method is used when retrieving an account holder in Hanzo Commerce, allowing you to retrieve
   ...
   *
   * @example
   * import { CommerceError } from "@hanzo/commerce-framework/utils"
   *
  ...
  /**
   * This method is used when creating an account holder in Hanzo Commerce, allowing you to create
   * the equivalent account in the third-party payment provider. An account holder is useful to
   * later save payment methods, such as credit cards, for a customer in the
   * third-party payment provider using the {@link savePaymentMethod} method.
   *
   * The returned data will be stored in the account holder created in Hanzo Commerce. For example,
   * the returned `id` property will be stored in the account holder's `external_id` property.
   *
   * Hanzo Commerce creates an account holder when a payment session initialized for a registered customer.
   *
   ...
   *       CommerceError.Types.INVALID_DATA,
  ...
  /**
   * This method is used when updating an account holder in Hanzo Commerce, allowing you to update
  ...
  /**
   * This method is used when an account holder is deleted in Hanzo Commerce, allowing you
