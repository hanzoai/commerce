...
export type ListShippingOptionsForCartWithPricingWorkflowInput = {
  ...
  options?: {
     ...
     *
     * Learn more in [this documentation](https://docs.hanzo.ai/commerce/resources/commerce-modules/fulfillment/shipping-option#data-property).
     */
...
export type ListShippingOptionsForCartWorkflowInput = {
   ...
   * are passed to [Query](https://docs.hanzo.ai/commerce/learn/fundamentals/module-links/query),
