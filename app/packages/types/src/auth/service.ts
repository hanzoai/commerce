...
export interface IAuthModuleService extends IModuleService {
   ...
   *
   * Refer to [this guide](https://docs.hanzo.ai/commerce/resources/commerce-modules/auth/authentication-route) to learn more about the authentication flows.
   *
   ...
   * `req` is an instance of the `CommerceRequest` object:
   *
   * ```ts
   ...
   *
   * Learn more about this authentication flow in [this guide](https://docs.hanzo.ai/commerce/resources/commerce-modules/auth/authentication-route#2-third-party-service-authenticate-flow).
   *
