...
export class Store {
   ...
   * [Get Store](https://docs.hanzo.ai/commerce/api/admin#stores_getstoresid)
   * API route.
   * 
   ...
   * [List Stores](https://docs.hanzo.ai/commerce/api/admin#stores_getstores)
   * API route.
   * 
   ...
   * [Update Store](https://docs.hanzo.ai/commerce/api/admin#stores_poststoresid)
   * API route.
   * 
