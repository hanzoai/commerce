...
export class ShippingOption {
   ...
   * [Create Shipping Option](https://docs.hanzo.ai/commerce/api/admin#shipping-options_postshippingoptions)
   * API route.
   * 
   ...
   * [Get Shipping Option](https://docs.hanzo.ai/commerce/api/admin#shipping-options_getshippingoptionsid)
   * API route.
   * 
   ...
   * [Update Shipping Option](https://docs.hanzo.ai/commerce/api/admin#shipping-options_postshippingoptionsid)
   * API route.
   * 
   ...
   * [Delete Shipping Option](https://docs.hanzo.ai/commerce/api/admin#shipping-options_deleteshippingoptionsid)
   * API route.
   * 
   ...
   * [List Shipping Options](https://docs.hanzo.ai/commerce/api/admin#shipping-options_getshippingoptions)
   * API route.
   * 
   ...
   * [Manage Rules of a Shipping Option](https://docs.hanzo.ai/commerce/api/admin#shipping-options_postshippingoptionsidrulesbatch)
   * API route.
   * 
