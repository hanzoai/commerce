...
export class Translation {
   ...
   * [List Translations](https://docs.hanzo.ai/commerce/api/admin#translations_gettranslations)
   * API route.
   *
   ...
   * [Manage Translations](https://docs.hanzo.ai/commerce/api/admin#translations_posttranslationsbatch)
   * API route.
   *
   ...
   * [Get Translation Settings](https://docs.hanzo.ai/commerce/api/admin#translations_gettranslationssettings) API route.
   *
   ...
   * [Batch Translation Settings](https://docs.hanzo.ai/commerce/api/admin#translations_posttranslationssettingsbatch)
   * API route.
   *
   * @since 2.12.6
   *
   ...
   * translatable fields.
   * It sends a request to the
   * [Get Translation Entities](https://docs.hanzo.ai/commerce/api/admin#translations_gettranslationentities) API route.
   *
   * @since 2.12.4
   *
   ...
   * It sends a request to the
   * [Get Translation Statistics](https://docs.hanzo.ai/commerce/api/admin#translations_gettranslationsstatistics) API route.
   *
