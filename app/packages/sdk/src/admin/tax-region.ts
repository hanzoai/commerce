...
export class TaxRegion {
   ...
   * [Create Tax Region](https://docs.hanzo.ai/commerce/api/admin#tax-regions_posttaxregions)
   * API route.
   *
   ...
   * [Update Tax Region](https://docs.hanzo.ai/commerce/api/admin#tax-regions_posttaxregionsid)
   * API route.
   * 
   * @since 2.8.0
   *
   ...
   * [Delete Tax Region](https://docs.hanzo.ai/commerce/api/admin#tax-regions_deletetaxregionsid)
   * API route.
   *
   ...
   * [Get Tax Region](https://docs.hanzo.ai/commerce/api/admin#tax-regions_gettaxregionsid)
   * API route.
   *
   ...
   * [List Tax Regions](https://docs.hanzo.ai/commerce/api/admin#tax-regions_gettaxregions)
   * API route.
   *
