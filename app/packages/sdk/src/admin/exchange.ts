import { HttpTypes, SelectParams } from "@hanzo/commerce-types"
...
export class Exchange {
   ...
   * [List Exchanges](https://docs.hanzo.ai/commerce/api/admin#exchanges_getexchanges)
   * API route.
   * 
   ...
   * [Get Exchange](https://docs.hanzo.ai/commerce/api/admin#exchanges_getexchangesid)
   * API route.
   * 
   ...
   * [Create Exchange](https://docs.hanzo.ai/commerce/api/admin#exchanges_postexchanges) API route.
   * 
   ...
   * [Cancel Exchange](https://docs.hanzo.ai/commerce/api/admin#exchanges_postexchangesidcancel) API route.
   * 
   * @param id - The exchange's ID.
   * @param query - Configure the fields to retrieve in the exchange.
   * @param headers - Headers to pass in the request.
   ...
   * 
   * This method sends a request to the [Add Inbound Items](https://docs.hanzo.ai/commerce/api/admin#exchanges_postexchangesidinbounditems)
   * API route.
   * 
   * @param id - The exchange's ID.
   ...
   * 
   * This method sends a request to the [Update Inbound Item](https://docs.hanzo.ai/commerce/api/admin#exchanges_postexchangesidinbounditemsaction_id)
   * API route.
   * 
   * @param id - The exchange's ID.
   ...
   * 
   * This method sends a request to the [Remove Inbound Item](https://docs.hanzo.ai/commerce/api/admin#exchanges_deleteexchangesidinbounditemsaction_id)
   * API route.
   * 
   * @param id - The exchange's ID.
   * @param actionId - The id of the return item's `RETURN_ITEM` action.
   ...
   * 
   * This method sends a request to the [Add Inbound Shipping](https://docs.hanzo.ai/commerce/api/admin#exchanges_postexchangesidinboundshippingmethod)
   * API route.
   * 
   * This method sends a request to the [Add Inbound Shipping](https://docs.hanzo.ai/commerce/api/admin#exchanges_postexchangesidinboundshippingmethod)
   * API route.
   ...
   * You can check the action's name using its `action` property, and use the value of the `id` property.
   * 
   * This method sends a request to the [Update Inbound Shipping](https://docs.hanzo.ai/commerce/api/admin#exchanges_postexchangesidinboundshippingmethodaction_id)
   * API route.
   * 
   * @param id - The exchange's ID.
   ...
   * You can check the action's name using its `action` property, and use the value of the `id` property.
   * 
   * This method sends a request to the [Remove Inbound Shipping](https://docs.hanzo.ai/commerce/api/admin#exchanges_deleteexchangesidinboundshippingmethodaction_id)
   * API route.
   * 
   * @param id - The exchange's ID.
   * @param actionId - The id of the shipping method's `SHIPPING_ADD` action.
   ...
   * 
   * This method sends a request to the [Add Outbound Items](https://docs.hanzo.ai/commerce/api/admin#exchanges_postexchangesidoutbounditems)
   * API route.
   * 
   * @param id - The exchange's ID.
   * @param body - The items to add.
   ...
   * You can check the action's name using its `action` property, and use the value of the `id` property.
   * 
   * This method sends a request to the [Update Inbound Item](https://docs.hanzo.ai/commerce/api/admin#exchanges_postexchangesidoutbounditemsaction_id)
   * API route.
   * 
   * @param id - The exchange's ID.
   ...
   * You can check the action's name using its `action` property, and use the value of the `id` property.
   * 
   * This method sends a request to the [Update Outbound Item](https://docs.hanzo.ai/commerce/api/admin#exchanges_deleteexchangesidoutbounditemsaction_id)
   * API route.
   * 
   * @param id - The exchange's ID.
   * @param actionId - The id of the new exchange item's `ITEM_ADD` action.
   ...
   * 
   * This method sends a request to the [Add Outbound Shipping](https://docs.hanzo.ai/commerce/api/admin#exchanges_postexchangesidoutboundshippingmethod)
   * API route.
   * 
   * @param id - The exchange's ID.
   * @param body - The shipping method's details.
   ...
   * You can check the action's name using its `action` property, and use the value of the `id` property.
   * 
   * This method sends a request to the [Update Outbound Shipping](https://docs.hanzo.ai/commerce/api/admin#exchanges_postexchangesidoutboundshippingmethodaction_id)
   * API route.
   * 
   * @param id - The exchange's ID.
   * @param actionId - The id of the shipping method's `SHIPPING_ADD` action.
   ...
   * You can check the action's name using its `action` property, and use the value of the `id` property.
   * 
   * This method sends a request to the [Remove Outbound Shipping](https://docs.hanzo.ai/commerce/api/admin#exchanges_deleteexchangesidoutboundshippingmethodaction_id)
   * API route.
   * 
   * @param id - The exchange's ID.
   * @param actionId - The id of the shipping method's `SHIPPING_ADD` action.
   ...
   * 
   * This method sends a request to the [Confirm Exchange](https://docs.hanzo.ai/commerce/api/admin#exchanges_postexchangesidrequest)
   * API route.
   * 
   * @param id - The exchange's ID.
   ...
   * [Cancel Exchange Request](https://docs.hanzo.ai/commerce/api/admin#exchanges_deleteexchangesidrequest)
   * API route.
   * 
   * @param id - The exchange's ID.
   * @param query - Configure the fields to retrieve in the exchange.
