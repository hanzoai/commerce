...
export class DraftOrder {
   ...
   * [Get Draft Order](https://docs.hanzo.ai/commerce/api/admin#draft-orders_getdraftordersid)
   * API route.
   *
   ...
   * [List Draft Orders](https://docs.hanzo.ai/commerce/api/admin#draft-orders_getdraftorders) API route.
   *
   ...
   * [Create Draft Order](https://docs.hanzo.ai/commerce/api/admin#draft-orders_postdraftorders) API route.
   *
   ...
   * [Delete Draft Order](https://docs.hanzo.ai/commerce/api/admin#draft-orders_deleteordereditsid) API route.
   *
   * @param id - The draft order's ID.
   * @param headers - Headers to pass in the request.
   *
   ...
   * [Update Draft Order](https://docs.hanzo.ai/commerce/api/admin#draft-orders_postdraftordersid) API route.
   *
   * @param id - The draft order's ID.
   ...
   * [Convert Draft Order to Order](https://docs.hanzo.ai/commerce/api/admin#draft-orders_postdraftordersidconverttoorder) API route.
   *
   * @param id - The draft order's ID.
   ...
   * [Add Draft Order Items](https://docs.hanzo.ai/commerce/api/admin#draft-orders_postdraftordersidedititems) API route.
   *
   * @param id - The draft order's ID.
   ...
   * [Update Draft Order Item](https://docs.hanzo.ai/commerce/api/admin#draft-orders_postdraftordersidedititemsaction_id) API route.
   *
   * @param id - The draft order's ID.
   ...
   * [Remove Draft Order Item](https://docs.hanzo.ai/commerce/api/admin#draft-orders_deletedraftordersidedititemsaction_id) API route.
   *
   * @param id - The draft order's ID.
   * @param actionId - The action ID.
   * @param headers - Headers to pass in the request.
   ...
   * [Update Draft Order Item](https://docs.hanzo.ai/commerce/api/admin#draft-orders_postdraftordersidedititemsitemitem_id) API route.
   *
   * @param id - The draft order's ID.
   ...
   * [Add Draft Order Promotions](https://docs.hanzo.ai/commerce/api/admin#draft-orders_postdraftordersideditpromotions) API route.
   *
   * @param id - The draft order's ID.
   ...
   * [Remove Draft Order Promotions](https://docs.hanzo.ai/commerce/api/admin#draft-orders_deletedraftordersideditpromotions) API route.
   *
   * @param id - The draft order's ID.
   ...
   * [Add Draft Order Shipping Method](https://docs.hanzo.ai/commerce/api/admin#draft-orders_postdraftordersideditshippingmethods) API route.
   *
   * @param id - The draft order's ID.
   ...
   * [Update Draft Order Shipping Method](https://docs.hanzo.ai/commerce/api/admin#draft-orders_postdraftordersideditshippingmethodsaction_id) API route.
   *
   * @param id - The draft order's ID.
   * @param actionId - The action ID.
   ...
   * [Remove Draft Order Shipping Method](https://docs.hanzo.ai/commerce/api/admin#draft-orders_deletedraftordersideditshippingmethodsaction_id) API route.
   *
   * @param id - The draft order's ID.
   * @param actionId - The action ID.
   * @param headers - Headers to pass in the request.
   ...
   * [Remove Draft Order Shipping Method](https://docs.hanzo.ai/commerce/api/admin#draft-orders_deletedraftordersideditshippingmethodsmethodmethod_id) API route.
   * 
   * @param id - The draft order's ID.
  ...
  /**
   * This method updates a shipping method in a draft order. It sends a request to the
   * [Update Draft Order Shipping Method](https://docs.hanzo.ai/commerce/api/admin#draft-orders_postdraftordersideditshippingmethodsmethodmethod_id) API route.
   *
   * @param id - The draft order's ID.
   ...
   * [Begin Draft Order Edit](https://docs.hanzo.ai/commerce/api/admin#draft-orders_postdraftordersidedit) API route.
   *
   * @param id - The draft order's ID.
   * @param headers - Headers to pass in the request.
   *
   ...
   * [Cancel Draft Order Edit](https://docs.hanzo.ai/commerce/api/admin#draft-orders_deletedraftordersidedit) API route.
   *
   * @param id - The draft order's ID.
   * @param headers - Headers to pass in the request.
   ...
   * [Request Draft Order Edit](https://docs.hanzo.ai/commerce/api/admin#draft-orders_postdraftordersideditrequest) API route.
   *
   * @param id - The draft order's ID.
   * @param headers - Headers to pass in the request.
   * @returns The draft order preview's details.
   ...
   * [Confirm Draft Order Edit](https://docs.hanzo.ai/commerce/api/admin#draft-orders_postdraftordersideditconfirm) API route.
   *
   * @param id - The draft order's ID.
   * @param headers - Headers to pass in the request.
   * @returns The draft order preview's details.
