...
export class Currency {
   ...
   * [List Currencies](https://docs.hanzo.ai/commerce/api/admin#currencies_getcurrencies)
   * API route.
   * 
   ...
   * [Get Currency](https://docs.hanzo.ai/commerce/api/admin#currencies_getcurrenciescode) API route.
   * 
