...
export class ProductCollection {
   ...
   * [Create Collection](https://docs.hanzo.ai/commerce/api/admin#collections_postcollections)
   * API route.
   * 
   ...
   * [Update Collection](https://docs.hanzo.ai/commerce/api/admin#collections_postcollectionsid)
   * API route.
   * 
   ...
   * [List Collections](https://docs.hanzo.ai/commerce/api/admin#collections_getcollections) API route.
   * 
   ...
   * [Get Collection](https://docs.hanzo.ai/commerce/api/admin#collections_getcollectionsid) API route.
   * 
   ...
   * [Delete Collection](https://docs.hanzo.ai/commerce/api/admin#collections_deletecollectionsid)
   * API route.
   * 
   * @param id - The collection's ID.
   * @param headers - Headers to pass in the request
   ...
   * to the [Manage Products](https://docs.hanzo.ai/commerce/api/admin#collections_postcollectionsidproducts)
   * API route.
   * 
   * @param id - The collection's ID.
