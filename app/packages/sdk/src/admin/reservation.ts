...
class Reservation {
   ...
   * [Get Reservation](https://docs.hanzo.ai/commerce/api/admin#reservations_getreservationsid)
   * API route.
   * 
   ...
   * [List Reservations](https://docs.hanzo.ai/commerce/api/admin#reservations_getreservations)
   * API route.
   * 
   ...
   * [Create Reservation](https://docs.hanzo.ai/commerce/api/admin#reservations_postreservations)
   * API route.
   * 
   ...
   * [Update Reservation](https://docs.hanzo.ai/commerce/api/admin#reservations_postreservationsid)
   * API route.
   * 
   * @param id - The reservation's ID.
   ...
   * [Delete Reservation](https://docs.hanzo.ai/commerce/api/admin#reservations_deletereservationsid)
   * API route.
   * 
   * @param id - The reservation's ID.
   * @param headers - Headers to pass in the request.
