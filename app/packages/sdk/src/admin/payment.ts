...
export class Payment {
   ...
   * [List Payments](https://docs.hanzo.ai/commerce/api/admin#payments_getpayments) API route.
   * 
   ...
   * [List Payment Providers](https://docs.hanzo.ai/commerce/api/admin#payments_getpaymentspaymentproviders) API route.
   * 
   * @param query - Filters and pagination configurations.
   * @param headers - Headers to pass in the request.
   ...
   * [Get Payment](https://docs.hanzo.ai/commerce/api/admin#payments_getpaymentsid)
   * API route.
   * 
   ...
   * [Capture Payment](https://docs.hanzo.ai/commerce/api/admin#payments_postpaymentsidcapture) API route.
   * 
   ...
   * [Refund Payment](https://docs.hanzo.ai/commerce/api/admin#payments_postpaymentsidrefund) API route.
   * 
