...
export class Product {
   ...
   * [Create Product Import](https://docs.hanzo.ai/commerce/api/admin#products_postproductsimport)
   * API route.
   *
   ...
   *
   * This method sends a request to the
   * [Create Product Import](https://docs.hanzo.ai/commerce/api/admin#products_postproductsimports)
   * API route.
   *
   * @since 2.8.5
   *
   ...
   * [Confirm Product Import](https://docs.hanzo.ai/commerce/api/admin#products_postproductsimporttransaction_idconfirm)
   * API route.
   *
   * @since 2.8.5
   *
   ...
   *
   * This method sends a request to the [Export Product](https://docs.hanzo.ai/commerce/api/admin#products_postproductsexport)
   * API route.
   *
   ...
   * [Manage Products](https://docs.hanzo.ai/commerce/api/admin#products_postproductsbatch)
   * API route.
   *
   ...
   * [Create Product](https://docs.hanzo.ai/commerce/api/admin#products_postproducts)
   * API route.
   *
   ...
   * [Update Product](https://docs.hanzo.ai/commerce/api/admin#products_postproductsid)
   * API route.
   *
   ...
   * [List Products](https://docs.hanzo.ai/commerce/api/admin#products_getproducts) API route.
   *
   ...
   * [Get Product](https://docs.hanzo.ai/commerce/api/admin#products_getproductsid)
   * API route.
   *
   * @param id - The product's ID.
   * @param query - Configure the fields to retrieve in the product.
   ...
   * [Delete Product](https://docs.hanzo.ai/commerce/api/admin#products_deleteproductsid)
   * API route.
   *
   * @param id - The product's ID.
   * @param headers - Headers to pass in the request
   ...
   * [Manage Variants](https://docs.hanzo.ai/commerce/api/admin#products_postproductsidvariantsbatch)
   * API route.
   *
   ...
   * [Create Variant](https://docs.hanzo.ai/commerce/api/admin#products_postproductsidvariants)
   * API route.
   *
   * @param productId - The product's ID.
   ...
   * [Update Variant](https://docs.hanzo.ai/commerce/api/admin#products_postproductsidvariantsvariant_id)
   * API route.
   *
   * @param productId - The product's ID.
  ...
  /**
   * This method retrieves a paginated list of products. It sends a request to the
   * [List Products](https://docs.hanzo.ai/commerce/api/admin#products_getproductsidvariants) API route.
   *
   ...
   * [Retrieve Variant](https://docs.hanzo.ai/commerce/api/admin#products_getproductsidvariantsvariant_id)
   * API route.
   *
   * @param productId - The product's ID.
   * @param id - The variant's ID.
   ...
   * [Delete Variant](https://docs.hanzo.ai/commerce/api/admin#products_deleteproductsidvariantsvariant_id)
   * API route.
   *
   * @param productId - The product's ID.
   ...
   *
   * It sends a request to the
   * [Manage Variant Inventory](https://docs.hanzo.ai/commerce/api/admin#products_postproductsidvariantsinventoryitemsbatch)
   * API route.
   *
   ...
   * [Create Option](https://docs.hanzo.ai/commerce/api/admin#products_postproductsidoptions)
   * API route.
   *
   * @param productId - The product's ID.
   ...
   * [Update Option](https://docs.hanzo.ai/commerce/api/admin#products_postproductsidoptionsoption_id)
   * API route.
   *
   * @param productId - The product's ID.
   ...
   * [List Options](https://docs.hanzo.ai/commerce/api/admin#products_getproductsidoptions) API route.
   *
   ...
   * [Get Option](https://docs.hanzo.ai/commerce/api/admin#products_getproductsidoptionsoption_id)
   * API route.
   *
   * @param productId - The product's ID.
   ...
   * [Delete Option](https://docs.hanzo.ai/commerce/api/admin#products_deleteproductsidoptionsoption_id)
   * API route.
   *
   * @param productId - The product's ID.
   ...
   * [Batch Image Variants](https://docs.hanzo.ai/commerce/api/admin#products_postproductsidimagesimage_idvariantsbatch)
   * API route.
   * 
   * @since 2.11.2
   *
   ...
   * [Batch Variant Images](https://docs.hanzo.ai/commerce/api/admin#products_postproductsidvariantsvariant_idimagesbatch)
   * API route.
   * 
   * @since 2.11.2
   *
