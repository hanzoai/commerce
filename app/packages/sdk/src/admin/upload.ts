...
export class Upload {
   ...
   * [Upload Files](https://docs.hanzo.ai/commerce/api/admin#uploads_postuploads)
   * API route.
   *
   ...
   * [Get File](https://docs.hanzo.ai/commerce/api/admin#uploads_getuploadsid)
   * API route.
   *
   ...
   * [Delete File](https://docs.hanzo.ai/commerce/api/admin#uploads_deleteuploadsid)
   * API route.
   *
