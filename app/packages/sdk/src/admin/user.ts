...
export class User {
   ...
   * [Update User](https://docs.hanzo.ai/commerce/api/admin#users_postusersid)
   * API route.
   * 
   ...
   * [List Users](https://docs.hanzo.ai/commerce/api/admin#users_getusers)
   * API route.
   * 
   ...
   * [Get User](https://docs.hanzo.ai/commerce/api/admin#users_getusersid)
   * API route.
   * 
   ...
   * [Delete User](https://docs.hanzo.ai/commerce/api/admin#users_deleteusersid)
   * API route.
   * 
   ...
   * [Get Logged-In User](https://docs.hanzo.ai/commerce/api/admin#users_getusersme)
   * API route.
   * 
   * @param query - Configure the fields and relations to retrieve in the user.
   * @param headers - Headers to pass in the request.
