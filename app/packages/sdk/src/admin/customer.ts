...
export class Customer {
   ...
   * [Create Customer](https://docs.hanzo.ai/commerce/api/admin#customers_postcustomers) API route.
   *
   ...
   * [Update Customer](https://docs.hanzo.ai/commerce/api/admin#customers_postcustomersid) API route.
   *
   ...
   * [List Customers](https://docs.hanzo.ai/commerce/api/admin#customers_getcustomers)
   * API route.
   *
   ...
   * [Get Customer](https://docs.hanzo.ai/commerce/api/admin#customers_getcustomersid)
   * API route.
   *
   * @param id - The customer's ID.
   * @param query - Configure the fields to retrieve in the customer.
   ...
   * [Delete Customer](https://docs.hanzo.ai/commerce/api/admin#customers_deletecustomersid)
   * API route.
   *
   * @param id - The customer's ID.
   * @param headers - Headers to pass in the request.
   ...
   * It sends a request to the [Manage Customers](https://docs.hanzo.ai/commerce/api/admin#customers_postcustomersidcustomergroups)
   * API route.
   *
   * @param id - The customer's ID.
   ...
   * [Create Customer Address](https://docs.hanzo.ai/commerce/api/admin#customers_postcustomersidaddresses)
   * API route.
   *
   * @param id - The customer's ID.
   ...
   * [Update Customer Address](https://docs.hanzo.ai/commerce/api/admin#customers_postcustomersidaddressesaddressid)
   * API route.
   *
   * @param id - The customer's ID.
   ...
   * [Delete Customer Address](https://docs.hanzo.ai/commerce/api/admin#customers_deletecustomersidaddressesaddressid)
   * API route.
   *
   * @param id - The customer's ID.
   * @param addressId - The customer address's ID.
   ...
   * [Get Customer Address](https://docs.hanzo.ai/commerce/api/admin#customers_getcustomersidaddressesaddressid)
   * API route.
   *
   * @param id - The customer's ID.
   * @param addressId - The customer address's ID.
   ...
   * [List Customer Addresses](https://docs.hanzo.ai/commerce/api/admin#customers_getcustomersidaddresses)
   * API route.
   *
   * @param id - The customer's ID.
   * @param headers - Headers to pass in the request.
