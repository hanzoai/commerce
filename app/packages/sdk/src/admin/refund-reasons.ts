...
export class RefundReason {
   ...
   * [List Refund Reasons](https://docs.hanzo.ai/commerce/api/admin#refund-reasons_getrefundreasons)
   * API route.
   *
   ...
   * [Get Refund Reason](https://docs.hanzo.ai/commerce/api/admin#refund-reasons_getrefundreasonsid)
   * API route.
   *
   * @since 2.11.0
   *
   ...
   * [Create Refund Reason](https://docs.hanzo.ai/commerce/api/admin#refund-reasons_postrefundreasons)
   * API route.
   *
   * @since 2.11.0
   *
   ...
   * [Update Refund Reason](https://docs.hanzo.ai/commerce/api/admin#refund-reasons_postrefundreasonsid)
   * API route.
   *
   * @since 2.11.0
   *
   ...
   * [Delete Refund Reason](https://docs.hanzo.ai/commerce/api/admin#refund-reasons_deleterefundreasonsid)
   * API route.
   *
   * @since 2.11.0
   *
