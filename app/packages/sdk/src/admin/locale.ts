...
export class Locale {
   ...
   * [List Locales](https://docs.hanzo.ai/commerce/api/admin#locales_getlocales)
   * API route.
   *
   ...
   * [Get Locale](https://docs.hanzo.ai/commerce/api/admin#locales_getlocalescode) API route.
   *
