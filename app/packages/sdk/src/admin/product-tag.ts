...
export class ProductTag {
   ...
   * [Create Product Tag](https://docs.hanzo.ai/commerce/api/admin#product-tags_postproducttags)
   * API route.
   * 
   ...
   * [Update Product Tag](https://docs.hanzo.ai/commerce/api/admin#product-tags_postproducttagsid)
   * API route.
   * 
   ...
   * [List Product Tags](https://docs.hanzo.ai/commerce/api/admin#product-tags_getproducttags) API route.
   * 
   ...
   * [Get Product Tag](https://docs.hanzo.ai/commerce/api/admin#product-tags_getproducttagsid) API route.
   * 
   ...
   * [Delete Product Tag](https://docs.hanzo.ai/commerce/api/admin#product-tags_deleteproducttagsid)
   * API route.
   * 
   * @param id - The tag's ID.
   * @param headers - Headers to pass in the request
