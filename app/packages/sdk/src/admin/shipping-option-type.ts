...
export class ShippingOptionType {
   ...
   * [Create Shipping Option Type](https://docs.hanzo.ai/commerce/api/admin#shipping-option-types_postshippingoptiontypes)
   * API route.
   *
   ...
   * [Update Shipping Option Type](https://docs.hanzo.ai/commerce/api/admin#shipping-option-types_postshippingoptiontypesid)
   * API route.
   *
   ...
   * [List Shipping Option Types](https://docs.hanzo.ai/commerce/api/admin#shipping-option-types_getshippingoptiontypes) API route.
   *
   ...
   * [Get Shipping Option Type](https://docs.hanzo.ai/commerce/api/admin#shipping-option-types_getshippingoptiontypesid)
   * API route.
   *
   * @param id - The shipping option type's ID.
   * @param query - Configure the fields to retrieve in the shipping option type.
   ...
   * [Delete Shipping Option Type](https://docs.hanzo.ai/commerce/api/admin#shipping-option-types_deleteshippingoptiontypesid)
   * API route.
   *
   * @param id - The shipping option type's ID.
   * @param headers - Headers to pass in the request
