...
export class ShippingProfile {
   ...
   * [Create Shipping Profile](https://docs.hanzo.ai/commerce/api/admin#shipping-profiles_postshippingprofiles)
   * API route.
   * 
   ...
   * [Update Shipping Profile](https://docs.hanzo.ai/commerce/api/admin#shipping-profiles_postshippingprofilesid)
   * API route.
   * 
   ...
   * [Delete Shipping Profile](https://docs.hanzo.ai/commerce/api/admin#shipping-profiles_deleteshippingprofilesid)
   * API route.
   * 
   ...
   * [List Shipping Profiles](https://docs.hanzo.ai/commerce/api/admin#shipping-profiles_getshippingprofiles)
   * API route.
   * 
   ...
   * [Get Shipping Profile](https://docs.hanzo.ai/commerce/api/admin#shipping-profiles_getshippingprofilesid)
   * API route.
   * 
