...
export class Notification {
   ...
   * [Get Notification](https://docs.hanzo.ai/commerce/api/admin#notifications_getnotificationsid)
   * API route.
   * 
   ...
   * [List Notifications](https://docs.hanzo.ai/commerce/api/admin#notifications_getnotifications)
   * API route.
   * 
