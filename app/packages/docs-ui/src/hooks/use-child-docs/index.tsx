...
import { ChevronDoubleRight, ExclamationCircle } from "@hanzo/commerce-icons"
      ...
      <>
        ...
        {!searchResult.length && (
          <div className="flex flex-col justify-center items-center gap-docs_0.75">
            <ExclamationCircle className="text-hanzo-fg-subtle" />
            <span className="text-compact-small-plus text-hanzo-fg-base text-center">
              No results found matching your query.
            </span>
            <span className="text-compact-small text-hanzo-fg-subtle text-center">
