...
const CLOUD_SUGGESTION: CardProps = {
  ...
  text: "Deploy and manage production-ready Hanzo Commerce applications with zero-configuration deployments, automatic scaling, and GitHub integration, and more.",
...
const BLOOM_SUGGESTION: CardProps = {
  ...
  href: "https://bloom.hanzo.ai",
}

type Suggestions = Map<string, CardProps>

export const hanzoSuggestions: Suggestions = new Map([
