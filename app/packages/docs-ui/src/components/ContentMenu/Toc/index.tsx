...
export const ContentMenuToc = () => {
  ...
  return (
    <div className="h-max max-h-full overflow-y-hidden flex relative flex-col">
      <div className="absolute left-0 top-docs_0.5 h-[calc(100%-8px)] w-[1.5px] bg-hanzo-border-base" />
      {items !== null && (
        <TocList
          items={items}
  ...
  return (
    <li className="w-full pt-docs_0.5 toc-item" data-testid="toc-item">
      <Link
        ...
        className={clsx(
          ...
          item.id !== activeItemId &&
            "text-hanzo-fg-muted hover:text-hanzo-fg-base border-transparent"
        )}
        style={{
      ...
      >
        <span
          className={clsx(
            "absolute left-0 top-0 w-[1.5px] h-full bg-hanzo-fg-base rounded-full",
