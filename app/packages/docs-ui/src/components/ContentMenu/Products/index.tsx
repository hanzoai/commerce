...
export const ContentMenuProducts = () => {
  ...
  return (
    <div className="flex flex-col gap-docs_0.5">
      <span className="text-x-small-plus text-hanzo-fg-muted">
        Modules used
      </span>
      {loadedProducts.map((product, index) => (
        ...
        >
          <BorderedIcon
            wrapperClassName={clsx("bg-hanzo-bg-base")}
          ...
          <span
            className={
              "text-hanzo-fg-subtle text-x-small-plus group-hover:text-hanzo-fg-base transition-colors"
            }
          >
            {product.title}
          </span>
