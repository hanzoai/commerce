...
import { BroomSparkle } from "@hanzo/commerce-icons"
...
export const ContentMenuActions = () => {
  ...
  return (
    <div className="flex flex-col gap-docs_0.5">
      <Link
        className="flex items-center gap-docs_0.5 text-hanzo-fg-subtle text-x-small-plus hover:text-hanzo-fg-base"
      ...
      {features?.aiAssistant && (
        <button
          className="appearance-none p-0 flex items-center gap-docs_0.5 text-hanzo-fg-subtle text-x-small-plus hover:text-hanzo-fg-base"
