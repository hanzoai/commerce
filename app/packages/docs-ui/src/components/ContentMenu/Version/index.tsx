...
export const ContentMenuVersion = () => {
  ...
  return (
    <Card
      ...
      className={clsx(
        "!border-0 !bg-hanzo-bg-component hover:!bg-hanzo-bg-component-hover",
        "hover:!bg-hanzo-bg-component-hover animation-fill-forwards",
        "opacity-0"
      )}
      iconClassName={clsx(
        "!shadow-none border-[0.5px] border-hanzo-alphas-alpha-250"
      )}
      cardRef={cardRef}
    />
  )
