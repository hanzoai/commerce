...
describe("interactions", () => {
  ...
  test("updates selected tab styles when selectedTabIndex changes", () => {
    ...
    expect(tabButtons[0]).toHaveClass("text-hanzo-contrast-fg-primary")
    expect(tabButtons[1]).toHaveClass("text-hanzo-contrast-fg-secondary")
    rerender(
      <VerticalCodeTabs
        tabs={tabs}
        selectedTabIndex={1}
    ...
    expect(tabButtons[0]).toHaveClass("text-hanzo-contrast-fg-secondary")
    expect(tabButtons[1]).toHaveClass("text-hanzo-contrast-fg-primary")
  })
})
