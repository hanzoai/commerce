      ...
      >
        <>
          {!collapsed && (
            <div
              className={clsx(
                "bg-hanzo-bg-base shadow-elevation-flyout dark:shadow-elevation-flyout-dark rounded",
                ...
                {path.steps.map((step, index) => (
                  ...
                  >
                    ...
                    >
                      ...
                      <span
                        className={clsx(
                          "text-compact-medium-plus text-hanzo-fg-base"
                        )}
                      >
                        {step.title}
                      </span>
          ...
          {collapsed && (
            <Button
              variant="secondary"
              className={clsx(
                "!p-[10px] !shadow-elevation-flyout dark:!shadow-elevation-flyout-dark !text-hanzo-fg-subtle w-fit h-fit",
