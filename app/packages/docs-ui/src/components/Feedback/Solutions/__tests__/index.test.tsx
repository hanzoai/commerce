...
const mockGitHubSearchItem: GitHubSearchItem = {
  url: "https://github.com/hanzoai/commerce/issues/123",
  html_url: "https://github.com/hanzoai/commerce/issues/123",
  title: "Test Issue",
}
...
const getGitHubSearchUrl = (query: string) =>
  `https://api.github.com/search/issues?q=${encodeURIComponent(`${query} repo:hanzoai/commerce is:closed is:issue`)}&sort=updated&per_page=3&advanced_search=true`
