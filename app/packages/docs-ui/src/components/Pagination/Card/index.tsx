import { TriangleLeftMini, TriangleRightMini } from "@hanzo/commerce-icons"
  ...
  return (
    <div
      className={clsx(
        ...
        "bg-hanzo-bg-component hover:bg-hanzo-bg-component-hover",
    ...
    >
      ...
      >
        ...
        >
          {parentTitle && (
            <span
              className="block text-compact-small text-hanzo-fg-subtle"
          ...
          <span
            className="block text-compact-small-plus text-hanzo-fg-base"
