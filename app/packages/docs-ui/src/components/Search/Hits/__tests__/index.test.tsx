...
describe("SearchHits", () => {
  ...
  test("renders community badge for non-Hanzo integrations", () => {
  ...
  test("does not render badge for Hanzo Commerce integrations", () => {
    const hitWithHanzo: HitType = {
      ...mockHits[0],
      integration_vendor: "Hanzo Commerce",
    }
    mockUseHits.mockReturnValue({
      items: [hitWithHanzo],
      sendEvent: mockSendEvent,
