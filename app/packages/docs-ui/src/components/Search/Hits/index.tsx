...
export const SearchHits = ({
  ...
  return (
    <div
      className={clsx(
        "overflow-auto",
        "[&_mark]:bg-hanzo-bg-highlight",
        "[&_mark]:text-hanzo-fg-interactive"
      )}
      data-group
    >
      {hits.map((item, index) => {
        ...
        return (
          <div
            ...
            className={clsx(
              "p-docs_0.5",
              "hover:bg-hanzo-bg-base-hover",
              "focus:bg-hanzo-bg-base-hover",
              "focus:outline-none",
          ...
          >
            ...
            >
              ...
              <span className="text-compact-small text-hanzo-fg-subtle text-ellipsis overflow-hidden">
                {item.type === "content" && (
                  <>
                    {/* @ts-expect-error React v19 doesn't see this type as a React element */}
              ...
              <span
                className={clsx(
                  ...
                  "text-hanzo-fg-muted items-center text-compact-x-small"
                )}
              >
                {hierarchies}
              </span>
            ...
            {!!item.integration_vendor &&
              item.integration_vendor !== "Hanzo Commerce" && (
