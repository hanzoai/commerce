...
export const ErrorPage = () => {
  return (
    <div className="w-full h-full bg-hanzo-bg-subtle flex items-center justify-center">
      <div className="flex gap-docs_1.5 flex-col items-center justify-center w-fit max-w-lg">
        ...
        <div className="flex flex-col items-center gap-docs_0.5">
          <h1 className="text-hanzo-fg-base text-2xl">
            Oops! Something went wrong.
          </h1>
          <span className="text-hanzo-fg-subtle txt-large-plus text-pretty text-center">
