...
export const CardLargeLayout = ({
  ...
  return (
    ...
    >
      <div
        className={clsx(
          "rounded-docs_DEFAULT bg-hanzo-bg-component w-[290px] h-[144px]",
      ...
      >
        {IconComponent && (
          <IconComponent
            className="text-hanzo-fg-subtle"
            width={32}
            height={32}
            viewBox="0 0 32 32"
          />
      ...
      <div className="flex flex-col">
        <div className="flex gap-docs_0.25 items-center text-hanzo-fg-base">
          {title && (
