      ...
      >
        <div className="flex gap-0.5">
          {nested && (
            <TriangleRightMini
              className={clsx(
                "text-hanzo-fg-subtle transition-transform",
                rotateForGroupName
              )}
            />
          )}
          {!nested && level > 1 && (
            <ArrowDownLeftMini
              className={clsx("text-hanzo-fg-subtle flip-y")}
            />
          )}
          {level === 1 && typeId.length > 0 && (
            ...
            >
              <Link
                className={clsx(
                  "text-hanzo-fg-interactive hover:text-hanzo-fg-interactive-hover"
                )}
              />
            </CopyButton>
          )}
          <div className="flex gap-0.75 flex-wrap flex-1">
            ...
            <span
              className="font-monospace text-compact-small-plus text-hanzo-fg-subtle"
            ...
            {item.featureFlag && (
              <FeatureFlagNotice
                ...
                badgeContent={
                  <FlagMini className="!text-hanzo-tag-green-text" />
                }
              />
            )}
            {item.expandable && (
