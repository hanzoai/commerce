...
import { ArrowUturnLeft, BarsThree, XMark } from "@hanzo/commerce-icons"
  ...
  return (
    <div className="flex lg:hidden justify-center items-center">
      <Button
        ...
        className="text-hanzo-fg-subtle !p-[6.5px]"
      ...
      <div
        className={clsx(
          ...
          "top-[52px] transition-[left] bg-hanzo-bg-subtle z-50",
          !isOpen && "-left-full",
          isOpen && "left-0"
        )}
