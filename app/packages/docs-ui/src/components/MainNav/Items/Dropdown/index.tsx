          ...
          icon={
            <TriangleDownMini
              className={clsx(
                ...
                isOpen && "rotate-180",
                isActive && "text-hanzo-fg-base hover:text-hanzo-fg-subtle",
                !isActive && "text-hanzo-fg-subtle hover:text-hanzo-fg-base"
              )}
            />
          }
          className="!flex"
      ...
      <div
        className={clsx(
          ...
          !isActive && [
            ...
            isOpen && "text-hanzo-fg-subtle",
          ],
          "hover:bg-hanzo-button-transparent-hover rounded-docs_sm px-docs_0.5",
          className
        )}
        tabIndex={-1}
