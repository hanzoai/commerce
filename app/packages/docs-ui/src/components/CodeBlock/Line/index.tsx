...
export const CodeBlockLine = ({
      ...
      {isTokenHighlighted && (
        <span
          className={clsx(
            ...
            codeBlockStyle === "loud" && [
              "top-0 h-full",
              "lg:bg-hanzo-alpha-white-alpha-6 lg:border lg:border-hanzo-alpha-white-alpha-12",
            ...
            codeBlockStyle === "subtle" && [
              ...
              "group-hover:scale-y-100 bg-hanzo-fg-base",
            ]
          )}
          ...
          <span
            ...
            className={clsx(
              ...
              isTokenHighlighted && [
                "relative z-[1]",
                codeBlockStyle === "subtle" &&
                  "group-hover:!text-hanzo-fg-on-color group-hover:dark:!text-hanzo-fg-on-inverted",
              ]
            )}
  ...
  return (
    <span
      ...
      className={clsx(
        "table-row",
        isHighlightedLine && "bg-hanzo-alpha-white-alpha-6",
        lineProps.className
      )}
