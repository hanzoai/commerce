    ...
    () =>
      clsx(
        ...
        !overrideColors.bg && [
          ...
          blockStyle === "subtle" && "bg-hanzo-bg-component",
        ]
      ),
  ...
  const lineNumbersColor = useMemo(
    () =>
      clsx(
        ...
        !overrideColors.lineNumbersBg && [
          blockStyle === "loud" && "text-hanzo-contrast-fg-secondary",
          blockStyle === "subtle" && "text-hanzo-fg-muted",
        ]
      ),
    [blockStyle, colorMode, overrideColors]
  )
  ...
  const innerBgColor = useMemo(
    () =>
      clsx(
        ...
        !overrideColors.innerBg && [
          blockStyle === "loud" && [
            hasInnerCodeBlock && "bg-hanzo-contrast-bg-subtle",
            !hasInnerCodeBlock && "bg-hanzo-contrast-bg-base",
          ],
    ...
    () =>
      clsx(
        ...
        !overrideColors.innerBorder && [
          blockStyle === "loud" && [
            hasInnerCodeBlock &&
              "border border-solid border-hanzo-contrast-border-bot rounded-docs_DEFAULT",
