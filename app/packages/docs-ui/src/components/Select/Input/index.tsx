  ...
  return (
    <div
      className={clsx(
        ...
        "border-hanzo-border-base rounded-docs_sm border border-solid",
        "bg-hanzo-bg-field shadow-button-neutral dark:shadow-button-neutral-dark",
        ...
        "text-hanzo-fg-base text-compact-medium",
        "disabled:bg-hanzo-bg-disabled",
        "disabled:text-hanzo-fg-disabled",
        "flex items-center gap-docs_0.5",
        !hasSelectedValues && "placeholder:text-hanzo-fg-muted",
        hasSelectedValues && "placeholder:text-hanzo-fg-base",
        className
      )}
      ref={ref}
      onClick={(e) => {
    ...
    >
      {hasSelectedValues && (
        ...
        >
          ...
          {showClearButton && (
            <XMarkMini
              className="text-hanzo-tag-neutral-icon"
              onClick={(e) => {
                e.stopPropagation()
                setSelected?.([])
              }}
      ...
      <ChevronUpDown className="text-hanzo-fg-muted" />
      <input
        type="hidden"
        name={props.name}
