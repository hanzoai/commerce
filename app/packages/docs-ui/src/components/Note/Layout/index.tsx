  ...
  return (
    <div
      className={clsx(
        ...
        "bg-hanzo-bg-component border border-hanzo-border-base"
      )}
      ...
      <span
        className={clsx(
          ...
          (type === "default" || type === "check") &&
            "bg-hanzo-tag-neutral-icon",
          (type === "error" || type === "warning") && "bg-hanzo-tag-red-icon",
          type === "success" && "bg-hanzo-tag-green-icon",
          // TODO remove once all soon components are removed
          type === "soon" && "bg-hanzo-tag-blue-icon"
        )}
        data-testid="note-layout-indicator"
      ></span>
      <div className="flex-1">
        <div className="text-small text-hanzo-fg-subtle [&_ol]:!mb-0 [&_ul]:!mb-0">
          <span
            className={clsx("text-small-plus text-hanzo-fg-base")}
