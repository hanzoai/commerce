...
describe("rendering", () => {
  ...
  test("renders colored indicator for default type", () => {
    ...
    expect(indicator).toHaveClass("bg-hanzo-tag-neutral-icon")
  })
  ...
  test("renders colored indicator for error type", () => {
    ...
    expect(indicator).toHaveClass("bg-hanzo-tag-red-icon")
  })
  ...
  test("renders colored indicator for success type", () => {
    ...
    expect(indicator).toHaveClass("bg-hanzo-tag-green-icon")
  })
  ...
  test("renders colored indicator for soon type", () => {
    ...
    expect(indicator).toHaveClass("bg-hanzo-tag-blue-icon")
  })
})
