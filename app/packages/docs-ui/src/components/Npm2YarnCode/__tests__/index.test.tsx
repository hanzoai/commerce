...
describe("render", () => {
  test("renders npm2yarn code", () => {
    const { container } = render(
      <Npm2YarnCode npmCode="npm install @hanzo/commerce" />
    )
    ...
    expect(yarnCodeBlock).toHaveTextContent("yarn add @hanzo/commerce")
    ...
    expect(pnpmCodeBlock).toHaveTextContent("pnpm add @hanzo/commerce")
    ...
    expect(npmCodeBlock).toHaveTextContent("npm install @hanzo/commerce")
  })

  test("renders npm2yarn code with custom code options", () => {
    const { container } = render(
      <Npm2YarnCode
        npmCode="npm install @hanzo/commerce"
        title="Custom Title"
      />
    )
    expect(container).toBeInTheDocument()
