...
import { ArrowDownRightMini } from "@hanzo/commerce-icons"
    ...
    return (
      <div className="mb-docs_1" ref={ref}>
        {manualTestTrigger && (
          <div
            className={clsx(
              "bg-hanzo-bg-component rounded-docs_DEFAULT",
          ...
          >
            ...
            >
              <ArrowDownRightMini className="text-hanzo-fg-muted" />
              ...
              <ArrowRightDownIcon className="text-hanzo-fg-muted" />
            </div>
            <div
              className={clsx(
                "border-t border-hanzo-border-base",
