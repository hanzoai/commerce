...
describe("rendering", () => {
  test("renders source code link", () => {
    const { container } = render(
      <SourceCodeLink link="https://github.com/hanzoai/commerce" />
    )
    const link = container.querySelector("[data-testid='source-code-link']")
    expect(link).toBeInTheDocument()
    expect(link).toHaveAttribute("href", "https://github.com/hanzoai/commerce")
  ...
  test("renders source code link with text", () => {
    const { container } = render(
      <SourceCodeLink
        link="https://github.com/hanzoai/commerce"
        text="Custom Text"
      />
    )
    const badge = container.querySelector("[data-testid='source-code-badge']")
