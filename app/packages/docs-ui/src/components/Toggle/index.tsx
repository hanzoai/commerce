import { Switch } from "@hanzo/commerce-ui"
  ...
  return (
    <Switch
      ...
      className={clsx(
        ...
        "[&_span]:bg-hanzo-fg-on-color [&_span]:shadow-details-switch-handle [&_span]:group-disabled:bg-ui-fg-disabled [&_span]:pointer-events-none",
