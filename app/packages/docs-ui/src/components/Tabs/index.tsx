...
import { Tabs as UiTabs } from "@hanzo/commerce-ui"
...
export const TabsTriggerVertical = ({
  ...
  return (
    <UiTabs.Trigger
      ...
      className={clsx(
        className,
        "px-docs_0.5 py-docs_0.25 !text-hanzo-fg-base text-compact-small data-[state=active]:!text-compact-small-plus",
        "[&[data-state=active]_svg]:!visible hover:!bg-hanzo-bg-base-hover rounded-docs_DEFAULT",
        "!shadow-none"
      )}
    >
