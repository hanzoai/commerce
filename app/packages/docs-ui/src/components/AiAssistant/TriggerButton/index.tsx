...
export const AiAssistantTriggerButton = () => {
  ...
  return (
    <Tooltip
      render={() => (
        <span className="flex gap-[5px] items-center">
          <Kbd className="bg-hanzo-bg-field-component border-hanzo-border-strong w-[18px] h-[18px] inline-block">
            {osShortcut}
          </Kbd>
          <Kbd className="bg-hanzo-bg-field-component border-hanzo-border-strong w-[18px] h-[18px] inline-block">
            i
    ...
    >
      ...
      >
        <BloomIcon className="text-hanzo-fg-subtle" />
        <span className="hidden md:inline-block text-hanzo-fg-subtle">
          Ask Bloom
        </span>
      </Button>
    </Tooltip>
