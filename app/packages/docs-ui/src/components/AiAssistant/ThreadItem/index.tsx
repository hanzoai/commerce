      ...
      >
        <div
          className={clsx(
            "flex flex-col gap-docs_0.75",
            item.type === "question" && [
              "rounded-docs_xl bg-hanzo-tag-neutral-bg",
                    ...
                    <CodeMdx
                      ...
                      codeBlockProps={{
                        ...
                        overrideColors: {
                          ...
                          innerBorder: "border-hanzo-contrast-border-bot",
                        },
                      }}
                    />
                  )
        ...
        {item.type === "error" && (
          <span className="text-hanzo-fg-error">{item.content}</span>
        )}
      </div>
    </div>
  )
