...
import { ShieldCheck, XMark } from "@hanzo/commerce-icons"
  ...
  return (
    <div
      className={clsx(
        ...
        "border-hanzo-border-base border-b"
      )}
    >
      <div className="flex gap-[6px] items-center">
        <span className="text-h3 text-hanzo-fg-base">Ask Bloom</span>
        <Tooltip
          tooltipChildren={
            <>
        ...
        >
          <ShieldCheck className="text-hanzo-fg-muted" />
        </Tooltip>
      </div>
      <Button
      ...
      >
        <XMark className="text-hanzo-fg-muted" height={15} width={15} />
      </Button>
    </div>
  )
}
