...
export const AiAssistantChatWindowInput = ({
  ...
  return (
    <div
      className={clsx(
        "px-docs_1 py-docs_0.75 border-t border-hanzo-border-base"
      )}
    >
      <form
      ...
      >
        <textarea
          className={clsx(
            "appearance-none text-base md:text-small placeholder:text-hanzo-fg-muted",
            "text-hanzo-fg-base max-h-[210px] overflow-auto resize-none bg-transparent",
            "focus:outline-none focus:ring-0 disabled:cursor-not-allowed max-h-[210px]",
            "disabled:!bg-transparent disabled:text-hanzo-fg-disabled disabled:placeholder:text-hanzo-fg-disabled"
          )}
          value={question}
          ...
          placeholder="Ask me a question about Hanzo Commerce..."
          disabled={loading}
        />
        <div className="flex items-center justify-end gap-docs_1">
          ...
          >
            <button
              ...
              className={clsx(
                ...
                !active &&
                  "bg-transparent hover:bg-hanzo-button-transparent-hover text-hanzo-fg-muted hover:text-hanzo-fg-subtle",
                active &&
                  "bg-hanzo-tag-orange-bg hover:bg-hanzo-tag-orange-bg-hover text-hanzo-tag-orange-text",
            ...
            >
              {!active && <LightBulb />}
              {active && (
                <LightBulbSolid className="text-hanzo-tag-orange-icon" />
              )}
              Deep Thinking
            </button>
          </Tooltip>
          <button
            className={clsx(
              "appearance-none p-0 text-hanzo-fg-base disabled:text-hanzo-fg-disabled",
              "transition-colors"
            )}
