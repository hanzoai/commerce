...
import { ArrowPathMini, MinusMini, PlusMini } from "@hanzo/commerce-icons"
import { DropdownMenu, Text } from "@hanzo/commerce-ui"
import {
  createNodeClusters,
  getNextCluster,
  ...
  return (
    <div className="h-[200px] w-full rounded-docs_DEFAULT">
      ...
      >
        <div className="relative size-full overflow-hidden object-contain rounded-docs_DEFAULT shadow-elevation-card-rest">
          <div>
            ...
            <motion.div
              ...
              className={clsx(
                "bg-hanzo-bg-subtle relative size-[500rem] origin-top-left items-start justify-start overflow-hidden",
        ...
        <div className="bg-hanzo-bg-base shadow-borders-base text-hanzo-fg-subtle absolute bottom-docs_1 left-docs_1.5 flex h-[28px] items-center overflow-hidden rounded-docs_sm">
          <div className="flex items-center">
            <button
              ...
              disabled={!canZoomIn}
              aria-label="Zoom in"
              className="disabled:text-hanzo-fg-disabled transition-fg hover:bg-hanzo-bg-base-hover active:bg-hanzo-bg-base-pressed focus-visible:bg-hanzo-bg-base-pressed border-r p-docs_0.25 outline-none"
            >
              <PlusMini />
            </button>
            <div>
              <DropdownMenu>
                <DropdownMenu.Trigger
                  className="disabled:text-hanzo-fg-disabled transition-fg hover:bg-hanzo-bg-base-hover active:bg-hanzo-bg-base-pressed focus-visible:bg-hanzo-bg-base-pressed flex w-[50px] items-center justify-center border-r p-docs_0.25 outline-none"
                ...
                <DropdownMenu.Content className="bg-hanzo-bg-base">
          ...
          <button
            ...
            className="disabled:text-hanzo-fg-disabled transition-fg hover:bg-hanzo-bg-base-hover active:bg-hanzo-bg-base-pressed focus-visible:bg-hanzo-bg-base-pressed p-docs_0.25 outline-none"
          >
            <ArrowPathMini />
          </button>
        </div>
