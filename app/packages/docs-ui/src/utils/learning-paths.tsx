...
const paths: LearningPathType[] = [
    ...
    steps: [
      {
        ...
        description:
          "Create a Next.js Starter Template and connect it to your Hanzo Commerce backend.",
        path: "#",
      },
      {
  ...
  },
  {
    ...
    steps: [
      ...
      },
      {
        ...
        descriptionJSX: (
          <>
            Add a payment provider to your Hanzo Commerce backend. You can choose to
            install a plugin or{" "}
      ...
      },
      {
        ...
        path: "/starters/nextjs-hanzo-starter",
        descriptionJSX: (
          <>
      ...
      },
      {
        ...
        descriptionJSX: (
          <>
            ...
            handles creating the subscription in Hanzo Commerce.
          </>
        ),
        path: "/development/events/create-subscriber",
      },
  ...
  },
  {
    ...
    description:
      "Utilize Hanzo Commerce's features and customization capabilities to build a B2B store.",
    steps: [
      {
        ...
        descriptionJSX: (
          <>
            ...
            wholesale products.
            <br />
            You can either use the Hanzo Commerce admin, or the{" "}
      ...
      },
      {
        ...
        descriptionJSX: (
          <>
            ...
            <br />
            You can use the Hanzo Commerce admin to add the products. Other alternatives
            are:
            <ul>
              <li>
              ...
              <li>
                <Link href="/user-guide/products/import">
                  Import Products Using Hanzo Commerce Admin
                </Link>
              </li>
              <li>
      ...
      },
      {
        ...
        descriptionJSX: (
          <>
            ...
            <br />
            You can use the Hanzo Commerce admin to add the price list. Other
            alternatives are:
            <ul>
              <li>
              ...
              <li>
                <Link href="/user-guide/price-lists/import">
                  Import Prices Using Hanzo Commerce Admin
                </Link>
              </li>
              <li>
      ...
      },
      {
        ...
        descriptionJSX: (
          <>
            ...
            recipe.
            <br />
            Hanzo Commerce can be customized to add custom entities, API Routes,
            services, and more.
            <br />
            You can find additional development resources in the{" "}
            <Link href="/development/overview">Hanzo Commerce development section</Link>
            .
          </>
        ),
      },
  ...
  },
  {
    ...
    description:
      "Use Hanzo Commerce’s architecture and functionalities to integrate third-party systems and build flows around them.",
    steps: [
      {
        ...
        descriptionJSX: (
          <>
            Hanzo Commerce Services let you implement a client that connects and
      ...
      },
      {
        ...
        descriptionJSX: (
          <>
            With Hanzo Commerce’s workflows, you can build flows with steps that may
      ...
      },
      {
        ...
        descriptionJSX: (
          <>
            ...
            <br />
            <br />
            Webhook listeners can be created in Hanzo Commerce using API Routes.
          </>
        ),
      },
    ],
