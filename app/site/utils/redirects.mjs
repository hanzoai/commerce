...
const redirects = async () => {
  return [
    ...
    {
      source: "/hanzo-react/:path*",
      destination: "/v1/hanzo-react/:path*",
      permanent: true,
    },
    {
    ...
    {
      source: "/learn/basics/hanzo-container",
      destination: "/learn/fundamentals/hanzo-container",
      permanent: true,
    },
    {
    ...
    {
      source: "/starters/nextjs-hanzo-starter",
      destination: "/resources/nextjs-starter",
      permanent: true,
    },
    {
    ...
    },
    {
      ...
      destination: "/resources/hanzo-commerce-cli",
      permanent: true,
    },
    {
    ...
    {
      source: "/v1/starters/nextjs-hanzo-starter",
      destination: "/resources/nextjs-starter",
      permanent: true,
    },
    {
    ...
    },
    {
      ...
      destination: "/learn/configurations/hanzo-commerce-config",
      permanent: true,
    },
    {
    ...
    {
      source: "/usage/create-hanzo-commerce-app",
      destination: "/learn/installation",
      permanent: true,
    },
    {
    ...
    {
      source: "/starters/gatsby-hanzo-starter",
      destination: "/resources/nextjs-starter",
      permanent: true,
    },
    {
