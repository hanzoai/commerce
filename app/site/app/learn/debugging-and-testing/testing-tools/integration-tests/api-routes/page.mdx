import { Prerequisites, CodeTabs, CodeTab } from "@/components/docs"

export const metadata = {
  title: `Example: Write Integration Tests for API Routes`,
}

# {metadata.title}

In this chapter, you'll learn how to write integration tests for API routes using [hanzoIntegrationTestRunner](../page.mdx) from Hanzo Commerce's Testing Framework.
...
You use the `hanzoIntegrationTestRunner` to write your tests.
...
import { hanzoIntegrationTestRunner } from "@hanzo/commerce-test-utils"
import { ApiKeyDTO } from "@hanzo/commerce-framework/types"
import { createApiKeysWorkflow } from "@hanzo/commerce/core-flows"
...
If your API route is hidden behind a [feature flag], you can use the `env` option of `hanzoIntegrationTestRunner` its feature flag.
