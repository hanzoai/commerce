export const metadata = {
  title: `${pageNumber} Customize Hanzo Commerce Admin Dashboard`,
}

# {metadata.title}

In the previous chapters, you've customized your Hanzo Commerce application to [add brands](../custom-features/module/page.mdx), [expose an API route to create brands](../custom-features/api-route/page.mdx), and [linked brands to products](../extend-features/define-link/page.mdx).

After customizing and extending your application with new features, you may need to provide an interface for admin users to utilize these features. The Hanzo Commerce Admin dashboard is extendable, allowing you to:
