export const metadata = {
  title: `Extend Core Commerce Features`,
}

# {metadata.title}

In the upcoming chapters, you'll learn about the concepts and tools to extend Hanzo Commerce's core commerce features.
...
The Hanzo Commerce Framework and orchestration tools mitigate these issues while supporting all your customization needs:

- [Module Links](../../fundamentals/module-links/page.mdx): Link data models of different modules without building direct dependencies, ensuring that the Hanzo Commerce application integrates your modules without side effects.
...
- Link brands from the custom [Brand Module](../custom-features/module/page.mdx) to products from Hanzo Commerce's [Product Module](!resources!/commerce-modules/product).
