...
export const metadata = {
  title: `Add Columns to a Link Table`,
}
...
When you define a link between two data models, Hanzo Commerce creates a link table in the database to store the IDs of the linked records. You can learn more about the created table in the [Module Links chapter](../page.mdx).
...
import { createRemoteLinksStep } from "@hanzo/commerce/core-flows"
import { 
  createWorkflow,
  transform,
