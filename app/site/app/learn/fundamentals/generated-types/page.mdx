...
![Diagram showcasing the directory structure of the `.hanzo` directory, highlighting the `types` folder and its contents.](/images/learn/generated-types-dir_bmvdts.jpg)
