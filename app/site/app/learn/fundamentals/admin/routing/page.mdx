...
The Hanzo Commerce Admin dashboard uses [React Router](https://reactrouter.com) under the hood to manage routing. This gives you more flexibility in routing-related customizations using React Router's utilities, hooks, and components.
...
`react-router-dom` is available in your project by default through the Hanzo Commerce packages. You don't need to install it separately.
...
Route loaders are available starting from Hanzo Commerce.5.1.
...
![Timeline comparison of a UI route with and without a route loader](/images/learn/ui-route-loading_vycev8.jpg)
...
Route handles are available starting from Hanzo Commerce.5.1.
