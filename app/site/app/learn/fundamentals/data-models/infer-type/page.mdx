export const metadata = {
  title: `Infer Type of Data Model`,
}
...
Instead, Hanzo Commerce provides `InferTypeOf` that transforms your data model to a type.
...
class BlogModuleService extends HanzoService({ Post }) {
