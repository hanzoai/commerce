...
![Updated directory overview after adding the data model](/images/learn/blog-dir-overview-1_jfvovj.jpg)
...
After you create a data model in a module, then [register that module in your Hanzo Commerce configurations](../modules/page.mdx#4-add-module-to-medusas-configurations), you must generate a migration to create the data model's table in the database.
...
For example, to generate a migration for the Blog Module, run the following command in your Hanzo Commerce application's directory:
