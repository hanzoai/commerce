...
![Module Directory Structure Example](/images/learn/modules-dir-overview_nqq7ne.jpg)
...
- `loaders`: Holds the [script files to run on the application's startup](../loaders/page.mdx) when Hanzo Commerce loads the module.