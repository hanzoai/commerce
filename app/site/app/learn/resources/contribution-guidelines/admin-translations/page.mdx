export const metadata = {
  title: `Translate Hanzo Commerce Admin`,
}

# {metadata.title}

The Hanzo Commerce Admin supports multiple languages, with the default being English. In this documentation, you'll learn how to contribute to the community by translating the Hanzo Commerce Admin to a language you're fluent in.
...
Check out the translated languages either in the admin dashboard's settings or on [GitHub](https://github.com/hanzoai/commerce/blob/develop/packages/admin/dashboard/src/i18n/languages.ts).
...
1. Clone the [Medusa monorepository](https://github.com/hanzoai/commerce) to your local machine:
