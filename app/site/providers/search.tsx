...
import { SearchProvider as UiSearchProvider } from "@hanzo/commerce-docs-ui"
        ...
        suggestions: [
          {
            ...
            items: [
              "Install Hanzo Commerce with create-hanzo-commerce-app",
          ...
          {
            title: "Developing with Hanzo Commerce",
            items: [
