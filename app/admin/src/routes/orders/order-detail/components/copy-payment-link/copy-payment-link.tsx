import { CheckCircleSolid, SquareTwoStack } from "@hanzo/commerce-icons"
import { AdminOrder, AdminPaymentCollection } from "@hanzo/commerce-types"
import { Button, Tooltip } from "@hanzo/commerce-ui"
import copy from "copy-to-clipboard"
import React, { useState } from "react"
import { useTranslation } from "react-i18next"
import { getStylizedAmount } from "../../../../../lib/money-amount-helpers"
import { HANZO_STOREFRONT_URL } from "../../../../../lib/storefront"
...
const CopyPaymentLink = React.forwardRef<any, CopyPaymentLinkProps>(
  ({ paymentCollection, order }: CopyPaymentLinkProps, ref) => {
    ...
    const copyToClipboard = async (
      ...
      setDone(true)
      copy(
        `${HANZO_STOREFRONT_URL}/payment-collection/${paymentCollection.id}`
      )
