  ...
  return (
    ...
    >
      ...
      <svg viewBox="0 0 67 67" xmlns="http://www.w3.org/2000/svg" className="h-full w-full">
        ...
        <rect x="44.5" y="0" width="22" height="22" fill="currentColor" />
        <path d="M66.7 22.3H22.3L0 44.6h44.5L66.7 22.3z" fill="currentColor" />
        <rect x="0" y="44.6" width="22" height="22.4" fill="currentColor" />
        <rect x="44.5" y="44.6" width="22" height="22.4" fill="currentColor" />
      </svg>
    </IconAvatar>
  )
}
