import { SalesChannelDetail } from '@/components/sales-channels/detail'

// `output: export` requires a dynamic segment to declare params at build time.
// Sales channels are per-org runtime data with no build-time ids, so we emit a
