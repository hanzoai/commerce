...
const FEATURES = [
  {
    title: 'Headless API',
    description: 'RESTful APIs designed for any frontend. Build custom storefronts with complete flexibility and zero vendor lock-in.',
    icon: (
  ...
  },
  {
    ...
    description: 'Native support for 100+ currencies with real-time exchange rates. Localized pricing and tax calculation built in.',
    icon: (
      <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
  ...
  {
    title: 'AI Pricing',
    description: 'Machine learning models that optimize pricing in real time. Maximize revenue with dynamic pricing strategies and demand forecasting.',
    icon: (
      <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
  ...
  },
  {
    ...
    description: 'Live dashboards with conversion funnels, cohort analysis, and revenue attribution. Make data-driven decisions instantly.',
    icon: (
      <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
  ...
  },
  {
    ...
    description: 'Pre-built, customizable storefront templates powered by Next.js. Launch a production-ready store in minutes, not months.',
    icon: (
      <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
    ...
    <>
      ...
      <section className="relative flex min-h-screen flex-col items-center justify-center overflow-hidden px-6 pt-16">
        <div className="pointer-events-none absolute inset-0">
          <div className="absolute left-1/2 top-0 h-[600px] w-[800px] -translate-x-1/2 rounded-full bg-white/[0.03] blur-[120px]" />
          <div className="absolute bottom-0 left-1/4 h-[400px] w-[600px] rounded-full bg-white/[0.02] blur-[100px]" />
        </div>
        ...
        <div className="relative z-10 mx-auto max-w-4xl text-center">
          ...
          <div className="flex flex-col items-center gap-4 sm:flex-row sm:justify-center">
            <Link
              href="/login"
              className="group inline-flex items-center gap-2 rounded-xl bg-white px-8 py-3.5 text-sm font-semibold text-black shadow-lg transition-all hover:bg-gray-200"
            >
              Get Started
        ...
        <div className="mx-auto max-w-7xl">
          ...
          <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
            {FEATURES.map((feature) => (
              ...
              >
                <div className="mb-4 flex h-12 w-12 items-center justify-center rounded-xl bg-white/10 text-white transition-colors group-hover:bg-white/20">
                  {feature.icon}
                </div>
      ...
      <section className="relative px-6 py-32">
        <div className="pointer-events-none absolute inset-0">
          <div className="absolute right-1/4 top-1/2 h-[400px] w-[600px] -translate-y-1/2 rounded-full bg-white/[0.02] blur-[100px]" />
        </div>

        <div className="relative mx-auto max-w-7xl">
          <div className="grid items-center gap-16 lg:grid-cols-2">
            <div>
              <h2 className="mb-4 text-3xl font-bold text-white sm:text-4xl">Developer-first API</h2>
              ...
              <div className="flex flex-col gap-4 sm:flex-row">
                <a href="https://docs.hanzo.ai" className="inline-flex items-center gap-2 text-sm font-medium text-white transition-colors hover:text-gray-300">
                  Read the documentation
                  <svg className="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                    <path strokeLinecap="round" strokeLinejoin="round" d="M13.5 4.5L21 12m0 0l-7.5 7.5M21 12H3" />
                  </svg>
                </a>
                <a href="https://docs.hanzo.ai/api" className="inline-flex items-center gap-2 text-sm font-medium text-gray-400 transition-colors hover:text-white">
                  API Reference
                  <svg className="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                    <path strokeLinecap="round" strokeLinejoin="round" d="M13.5 4.5L21 12m0 0l-7.5 7.5M21 12H3" />
                  </svg>
            ...
            <div className="overflow-hidden rounded-2xl border border-white/[0.06] bg-[#111111]">
              <div className="flex items-center gap-2 border-b border-white/[0.06] px-4 py-3">
                ...
                <div className="h-3 w-3 rounded-full bg-white/10" />
                <div className="h-3 w-3 rounded-full bg-white/10" />
                <span className="ml-2 text-xs text-gray-500">commerce.ts</span>
              </div>
              <pre className="overflow-x-auto p-6 text-sm leading-relaxed">
                <code className="font-mono text-gray-300">{CODE_EXAMPLE}</code>
              </pre>
            </div>
          </div>
        </div>
