...
This component is useful if you want to control the prompt's content, format, and design. For a simpler approach that follows Hanzo Commerce's prompt format, refer to the [usePrompt hook](../../hooks/use-prompt/page.mdx).
