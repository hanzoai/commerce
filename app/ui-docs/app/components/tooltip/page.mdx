...
## Usage Outside Hanzo Commerce Admin with TooltipProvider

If you're using the `Tooltip` component in a project other than the Hanzo Commerce Admin, make sure to include the `TooltipProvider` somewhere up in your component tree:
