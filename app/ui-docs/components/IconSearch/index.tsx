...
import { CopyButton } from "@hanzo/commerce-docs-ui"
...
const SearchResults = ({ query = "" }: { query?: string }) => {
  ...
  if (results.length === 0) {
    return (
      <div
        className={clsx(
          "text-hanzo-text-muted dark:text-hanzo-text-muted-dark",
          ...
          >
            <CopyButton text={name} tooltipText={name} handleTouch>
              ...
              >
                ...
                <div
                  className={clsx(
                    "bg-hanzo-bg-component text-hanzo-fg-base",
