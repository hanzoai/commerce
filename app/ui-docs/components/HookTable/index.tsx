...
import { InlineCode, Table, Tooltip } from "@hanzo/commerce-docs-ui"
        ...
        <div className="flex items-center gap-x-1">
          ...
          {!isReturn && description && (
            <Tooltip content={description} className="max-w-[350px] text-left">
              <InformationCircleSolid className="text-hanzo-fg-subtle" />
            </Tooltip>
          )}
        </div>
      </Table.Cell>
      ...
      <Table.Cell className="!text-right">
        {isReturn ? (
          description ? (
            ...
            <span className="text-hanzo-fg-muted"> - </span>
          )
