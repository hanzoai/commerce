...
import { Tabs, clx } from "@hanzo/commerce-ui"
import { CodeBlock } from "@hanzo/commerce-docs-ui"
      ...
      <Tabs defaultValue="preview" className="relative mr-auto w-full">
        <div className="flex flex-col pb-3">
          ...
          >
            <div
              className={clx(
                "bg-hanzo-bg-base border-hanzo-border-base flex max-h-[400px] min-h-[400px]",
            ...
            >
              <React.Suspense
                fallback={
                  <div className="text-hanzo-fg-muted flex items-center text-sm">
