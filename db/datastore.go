...
// This connects to Hanzo Datastore via hanzo-ds/go for deep analytics
...
// datastoreConn implements Datastore using Hanzo Datastore via hanzo-ds/go
...
type SyncConfig struct {
	...
	// AsyncInsert uses the datastore's async insert for fire-and-forget
	AsyncInsert bool
}
