...
// datastoreImpl implements Datastore using Datastore via hanzo/datastore-go
...
func (c *datastoreImpl) Query(ctx context.Context, query string, args ...interface{}) (DatastoreRows, error) {
...
func (c *datastoreImpl) Select(ctx context.Context, dest interface{}, query string, args ...interface{}) error {
	// Apply query timeout if configured
	if c.config.QueryTimeout > 0 {
		var cancel context.CancelFunc
		ctx, cancel = context.WithTimeout(ctx, c.config.QueryTimeout)
...
func (c *datastoreImpl) Exec(ctx context.Context, query string, args ...interface{}) error {
	// Apply query timeout if configured
	if c.config.QueryTimeout > 0 {
		var cancel context.CancelFunc
		ctx, cancel = context.WithTimeout(ctx, c.config.QueryTimeout)
...
func (c *datastoreImpl) PrepareBatch(ctx context.Context, query string) (DatastoreBatch, error) {
...
func (c *datastoreImpl) AsyncInsert(ctx context.Context, query string, wait bool, args ...interface{}) error {
	// Convert []interface{} to []any for datastore-go
	anyArgs := make([]any, len(args))
	for i, arg := range args {
		anyArgs[i] = arg
...
func (c *datastoreImpl) Close() error {
	if c.conn != nil {
		return c.conn.Close()
	}
	return nil
