...
func MemberExists(c context.Context, name, value string) bool {
...
func AddSetMember(c context.Context, name, value string) error {
...
func AddMember(c context.Context, name, value string) error {
	return AddMemberTask.Call(c, name, value)
}
