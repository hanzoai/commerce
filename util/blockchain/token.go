...
// wired by the github.com/hanzoai/commerce/EVM provider (luxfi/cevm) on
...
// registered implementation (an EVM provider (luxfi/cevm) not imported).
var ErrNoTokenTransfer = errors.New("blockchain: no ERC-20 token transfer registered (wire an EVM provider (luxfi/cevm) to enable ERC-20)")
