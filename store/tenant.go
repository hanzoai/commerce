...
// — suffix spoofing ("pay.redacted.com.evil.com") does not match.
func (r *TenantRepo) FindByHostname(host string) (*Tenant, error) {
	...
	//
	//   hostnames  = ["pay.redacted.com", "pay.dev.redacted.com"]
	//   pattern    = %"pay.redacted.com"%
	//
...
//   - lowercase
//   - trailing "." stripped (absolute DNS form — "pay.redacted.com." == "pay.redacted.com")
//   - :port stripped
