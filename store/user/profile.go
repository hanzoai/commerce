...
func updateContact(c *gin.Context, user *user.User) bool {
...
func updateBilling(c *gin.Context, user *user.User) bool {
...
func updateMetadata(c *gin.Context, user *user.User) bool {
...
func updatePassword(c *gin.Context, user *user.User) bool {
	form := new(ChangePasswordForm)
	if err := form.Parse(c); err != nil {
		log.Panic("Failed to update user password: %v", err)
	}

	if !password.HashAndCompare(user.PasswordHash, form.OldPassword) {
