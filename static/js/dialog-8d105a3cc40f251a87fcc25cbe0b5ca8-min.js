...
YUI.add("squarespace-flyout-error-message-template", function(b) {
  ...
  (function() {
    var a = c.template;
    (c.templates = c.templates || {})["flyout-error-message.html"] = a(function(a, b, g, c, h) {
      this.compilerInfo = [4, ">= 1.0.0"];
      g = this.merge(g, a.helpers);
      h = h || {};
      a = '<div class="sqs-flyout-error-message">';
      (g = g.message) ? g = g.call(b, {
        hash: {},
        data: h
      }) : (g = b.message, g = "function" === typeof g ? g.apply(b) : g);
      if (g || 0 === g) a += g;
      return a + "</div>"
    })
  })();
...
YUI.add("slider-value-range", function(b, c) {
  ...
  b.SliderValueRange = b.mix(function() {
    ...
    prototype: {
      ...
      _setNewValue: function(d) {
        return b.Lang.isNumber(d) ? a(this._nearestValue(d)) : b.Attribute.INVALID_VALUE
      },
...
YUI.add("datatable-core", function(b, c) {
  ...
  b.mix(d.prototype, {
    getColumn: function(a) {
      var b, d, e;
      if (b = g(a) && !f(a) ? a && a._node ? this.body.getColumn(a) : a : this.get("columns." + a)) return b;
      b = this.get("columns");
      if (k(a) || f(a)) {
        a = m(a);
        e = b;
        b = 0;
        for (d = a.length - 1; e && b < d; ++b) e = e[a[b]] && e[a[b]].children;
        return e && e[a[b]] || null
      }
      return null
    },
    ...
    _afterRecordTypeChange: function(a) {
      ...
      this.data.reset(b);
      !this.get("columns") && b && (b.length ? this._initColumns() : this.set("columns", l(a.newVal.ATTRS)))
    },
    ...
    _initColumns: function() {
      var a = this.get("columns") || [],
        b;
      !a.length && this.data.size() && (b = this.data.item(0), b.toJSON && (b = b.toJSON()), this.set("columns", l(b)));
    ...
    _initDataProperty: function(a) {
      var e;
      this.data || (e = this.get("recordType"), this.data = a && a.each && a.toJSON ? a : new b.ModelList,
      e && (this.data.model = e), this.data.addTarget(this))
    },
    initializer: function(a) {
      var b = a.data,
        e = a.columns;
      this._initDataProperty(b);
      e || ((a = (a.recordType || a.data === this.data) && this.get("recordType")) ? e = l(a.ATTRS) : f(b) && b.length && (e = l(b[0])), e && this.set("columns", e));
      this._initColumns();
      this._eventHandles = {};
    ...
    _setColumnMap: function(a) {
      function b(a) {
        var d, g, c, f;
        d = 0;
        for (g = a.length; d < g; ++d) c = a[d], (f = c.key) && !e[f] && (e[f] = c), e[c._id] = c, c.children && b(c.children)
      }
      var e = {};
      b(a);
      this._columnMap = e
    ...
    _setColumns: function(a) {
      function e(a) {
        ...
        k.push(a);
        m.push(b);
        for (d in a) a.hasOwnProperty(d) && (c = a[d], f(c) ? b[d] = c.slice() : g(c, !0) ? (h = l(k, c), b[d] = -1 === h ? e(c) : m[h]) : b[d] = a[d]);
        return b
      }
      function d(a, g) {
        var k = [],
        ...
        for (m = a.length; p < m; ++p) {
          ...
          l = b.stamp(q);
          q.id || (q.id = l);
          q.field && (q.name = q.field);
          g ? q._parent = g : delete q._parent;
          l = q;
          var t = q.name || q.key || q.id,
            t = t.replace(/\s+/, "-");
          c[t] ? t += c[t]++ : c[t] = 1;
          l._id = t;
          f(q.children) && (q.children = d(q.children, q))
        }
        return k
      }
      var c = {}, k = [],
    ...
    _setData: function(b) {
      null === b && (b = []);
      if (f(b)) this._initDataProperty(), this.data.reset(b, {
        silent: !0
      }), b = this.data;
    ...
    _setRecordset: function(a) {
      var e;
      a && (b.Recordset && a instanceof b.Recordset) && (e = [], a.each(function(a) {
        e.push(a.get("data"))
      }), a = e);
      this.set("data", a);
      return a
    ...
    _setRecordType: function(b) {
      var d;
      e(b) && b.prototype.toJSON && b.prototype.setAttrs ? d = b : g(b) && (d = this._createRecordClass(b));
      return d || a
    }
  })
}, "3.17.2", {
      ...
      if (c && this.get("rendered")) {
        ...
        var g = e.flyoutPlugin,
          f = b.bind(function() {
            ...
            var f = b.one(window).get("region"),
              m = b.Squarespace.Utils.measureNode(this._errorNode).width,
              d = e.get("region");
            d.right + m <= f.right ? (f = "rt", this._errorNode.addClass("out-from-right")) : d.left - m > f.left ? (f = "lt", this._errorNode.addClass("out-from-left")) : (f = "bl", this._errorNode.addClass("out-from-bottom"), this._errorNode.setStyle("width",
            d.width));
            g.setAttrs({
        ...
        g.get("visible") ? (this._isHiding = !0, this._showErrorSub && this._showErrorSub.detach(), this._showErrorSub = g.once(this.get("id") + "|hidden", function() {
...
YUI.add("datatable-sort", function(b, c) {
  ...
  b.mix(a.prototype, {
    sort: function(a, e) {
      return this.fire("sort", b.merge(e || {}, {
    ...
    toggleSort: function(a, e) {
      var d = this._sortBy,
        g = [],
        c, f, h;
      c = 0;
      for (f = d.length; c < f; ++c) h = {}, h[d[c]._id] = d[c].sortDir, g.push(h);
      if (a) {
        a = k(a);
        c = 0;
        for (f = a.length; c < f; ++c) {
          h = a[c];
          for (d = g.length - 1; 0 <= c; --c) if (g[d][h]) {
            g[d][h] *= -1;
            break
          }
        }
        ...
        c = 0;
        for (f = g.length; c < f; ++c) for (h in g[c]) if (g[c].hasOwnProperty(h)) {
          g[c][h] *= -1;
          break
        }
      }
    ...
    _afterSortRecordChange: function(a) {
      var b, d;
      b = 0;
      for (d = this._sortBy.length; b < d; ++b) if (a.changed[this._sortBy[b].key]) {
        this.data.sort();
        break
      }
    },
    ...
    _getSortBy: function(a, b) {
      ...
      if ("state" === b) {
        d = [];
        e = 0;
        for (g = this._sortBy.length; e < g; ++e) c = this._sortBy[e], d.push({
          column: c._id,
          dir: c.sortDir
        });
        return {
          state: 1 === d.length ? d[0] : d
        }
      }
      return a
    },
    ...
    _initSortFn: function() {
      var a = this;
      this.data._compare = function(b, d) {
        var e = 0,
          g, c, f, h, k;
        g = 0;
        for (c = a._sortBy.length; !e && g < c; ++g) f = a._sortBy[g], e = f.sortDir, h = f.caseSensitive,
        f.sortFn ? e = f.sortFn(b, d, - 1 === e) : (k = b.get(f.key) || "", f = d.get(f.key) || "", !h && ("string" === typeof k && "string" === typeof f) && (k = k.toLowerCase(), f = f.toLowerCase()), e = k > f ? e : k < f ? -e : 0);
        return e
      };
    ...
    _onUITriggerSort: function(a) {
      var b = a.currentTarget.getAttribute("data-yui3-col-id"),
        d = b && this.getColumn(b),
        e, g, c;
      if (!("keydown" === a.type && 32 !== a.keyCode) && (a.preventDefault(), d)) {
        if (a.shiftKey) {
          e = this.get("sortBy") || [];
          g = 0;
          for (c = e.length; g < c; ++g) if (b === e[g] || 1 === Math.abs(e[g][b])) {
            h(e[g]) || (e[g] = {});
            e[g][b] = -(d.sortDir || 0) || 1;
            break
          }
          g >= c && e.push(d._id)
        } else e = [{}], e[0][b] = -(d.sortDir || 0) || 1;
        this.fire("sort", {
          originEvent: a,
          sortBy: e
        })
    ...
    _parseSortable: function() {
      ...
      if (f(a)) {
        ...
        for (d = a.length; e < d; ++e) {
          g = a[e];
          if (!h(g, !0) || f(g)) g = this.getColumn(g);
          g && b.push(g)
        }
      } else if (a && (b = this._displayColumns.slice(), "auto" === a)) for (e = b.length - 1; 0 <= e; --e) b[e].sortable || b.splice(e, 1);
      this._sortable = b
    },
    ...
    _setSortBy: function() {
      var a = this._displayColumns,
        b = this.get("sortBy") || [],
        e = " " + this.getClassName("sorted"),
        d, g, c, f;
      this._sortBy = [];
      d = 0;
      for (g = a.length; d < g; ++d) c = a[d], delete c.sortDir, c.className && (c.className = c.className.replace(e, ""));
      b = k(b);
      d = 0;
      for (g = b.length; d < g; ++d) {
        c = b[d];
        a = 1;
        if (h(c)) for (c in f = c, f) if (f.hasOwnProperty(c)) {
          a = l[f[c]];
          break
        }
        c && (c = this.getColumn(c) || {
          _id: c,
          key: c
        }, c.sortDir = a, c.className || (c.className = ""), c.className += e, this._sortBy.push(c))
      }
    },
    ...
    _uiSetSortable: function() {
      var a = this._sortable || [],
        e = this.getClassName("sortable", "column"),
        d = this.getClassName("sorted"),
        g = this.getClassName("sorted", "desc"),
        c = this.getClassName("sort", "liner"),
        f = this.getClassName("sort", "indicator"),
        h = {}, k, l, u, v, w, B;
      this.get("boundingBox").toggleClass(this.getClassName("sortable"), a.length);
      k = 0;
      for (l = a.length; k < l; ++k) h[a[k].id] = a[k];
      this._theadNode.all("." + e).each(function(a) {
        var b = h[a.get("id")],
          k = a.one("." + c);
        b ? b.sortDir || a.removeClass(d).removeClass(g) : (a.removeClass(e).removeClass(d).removeClass(g), k && k.replace(k.get("childNodes").toFrag()), (a = a.one("." + f)) && a.remove().destroy(!0))
      });
      k = 0;
      for (l = a.length; k < l; ++k) u = a[k], v = this._theadNode.one("#" + u.id), B = -1 === u.sortDir, v && (w = v.one("." + c), v.addClass(e), u.sortDir && (v.addClass(d), v.toggleClass(g, B), v.setAttribute("aria-sort", B ? "descending" : "ascending")), w || (w = b.Node.create(b.Lang.sub(this.SORTABLE_HEADER_TEMPLATE, {
        className: c,
        indicatorClass: f
      })), w.prepend(v.get("childNodes").toFrag()), v.append(w)), w = m(this.getString(1 === u.sortDir ? "reverseSortBy" : "sortBy"), {
        title: u.title || "",
        key: u.key || "",
        abbr: u.abbr || "",
        label: u.label || "",
        column: u.abbr || u.label || u.key || "column " + k
      }), v.setAttribute("title", w), v.setAttribute("aria-labelledby", u.id))
    },
    _validateSortable: function(a) {
      return "auto" === a || e(a) || f(a)
    },
    _validateSortBy: function(a) {
      return null === a || g(a) || h(a, !0) || f(a) && (g(a[0]) || h(a, !0))
    }
  }, !0);
...
YUI.add("squarespace-toggle", function(b) {
  ...
  b.namespace("Squarespace.Widgets").ToggleButton = b.Base.create("toggleButton", b.Widget, [b.WidgetChild], {
    renderUI: function() {
      var a = this.get("contentBox"),
        d = this.get("active") ? "active" : "inactive";
      a.append(b.DB.DIV("switch-box-container animate " + d, b.DB.DIV("switch-box", b.DB.DIV("toggle-box", b.DB.DIV("togglebg", b.DB.DIV("on", {
    ...
    syncUI: function() {
      ...
      e ? b.removeClass("inactive").addClass("active") : b.removeClass("active").addClass("inactive");
  ...
  b.extend(c, b.Plugin.Base, {
    ...
    _afterBindUI: function() {
      ...
      this._handleDrag.on(d + "|drag:start", this._onDragStart, this);
      this._handleDrag.on(d + "|drag:drag", this._onDragDrag,
      this);
      this._handleDrag.on(d + "|drag:end", this._onDragEnd, this)
    },
    _onDragStart: function(a) {
      a = a.target;
      var d = this._host.get("contentBox").one(".handle-wrapper").get("region");
    ...
    _onDragDrag: function(a) {
      var b = a.target,
        e = this._host.get("contentBox"),
        g = this.get("maxValue"),
        c = e.one(".handle-wrapper").getX(),
        b = Math.abs(c - b.lastXY[0]),
        b = Math.max(0, b),
        b = Math.min(g, b);
      e.one(".togglebg").setStyle("marginLeft", b);
      e.one(".handle").setStyle("left", a.target.get("dragNode").getX() - e.one(".handle-wrapper").getX())
    },
    _onDragEnd: function(a) {
      a = a.target;
      var b = a.get("node"),
        e = a.con.get("constrain"),
        e = Math.abs(e.left - e.right);
      a = Math.abs(a.nodeXY[0] - a.lastXY[0]) / (e - b.get("offsetWidth"));
...
YUI.add("dd-scroll", function(b, c) {
  ...
  b.extend(a, b.Base, {
    ...
    _getVPRegion: function() {
      var a = {}, a = this.get("parentScroll"),
        ...
        e = d ? [] : a.getXY(),
        c = d ? "winWidth" : "offsetWidth",
        l = d ? "winHeight" : "offsetHeight",
        p = d ? a.get("scrollTop") : e[1],
        d = d ? a.get("scrollLeft") : e[0];
    ...
    _checkWinScroll: function(a) {
      var b = this._getVPRegion(),
        d = this.get("host"),
        e = this.get("windowScroll"),
        c = d.lastXY,
        l = !1,
        p = this.get("buffer"),
        n = this.get("parentScroll"),
        s = n.get("scrollTop"),
        r = n.get("scrollLeft"),
        q = c[1] + this._dimCache.h,
        t = c[1],
        x = c[0] + this._dimCache.w,
        z = c[0],
        y = t,
        u = z,
        v = s,
        w = r;
      this.get("horizontal") && (z <= b.left && (l = !0, u = c[0] - (e ? p : 0), w = r - p), x >= b.right && (l = !0, u = c[0] + (e ? p : 0), w = r + p));
      this.get("vertical") && (q >= b.bottom && (l = !0, y = c[1] + (e ? p : 0), v = s + p), t <= b.top && (l = !0, y = c[1] - (e ? p : 0), v = s - p));
      0 > v && (v = 0, y = c[1]);
      0 > w && (w = 0, u = c[0]);
      0 > y && (y = c[1]);
      0 > u && (u = c[0]);
      a ? (d.actXY = [u, y], d._alignNode([u, y], !0), d.actXY = [u, y], d._moveNode({
        node: n,
        top: v,
        left: w
      }), !v && !w && this._cancelScroll()) : l ? this._initScroll() : this._cancelScroll()
    },
  ...
  e.ATTRS = b.merge(a.ATTRS, {
    node: {
      ...
      setter: function(a) {
        var d = b.one(a);
        d ? this.set("parentScroll", d) : !1 !== a && b.error("DDNodeScroll: Invalid Node Given: " + a);
        return d
      }
    }
  });
    ...
    prototype: {
      ...
      _defRailMouseDownFn: function(a) {
        ...
        var b = this._resolveThumb(a),
          e = this._key.xyIndex,
          c = parseFloat(this.get("length"), 10),
          f, h;
        b && (f = b.get("dragNode"), h = parseFloat(f.getStyle(this._key.dim), 10), f = this._getThumbDestination(a, f), f = f[e] - this.rail.getXY()[e], f = Math.min(Math.max(f, 0), c - h), this._uiMoveThumb(f, {
          source: "rail"
      ...
      _getThumbDestination: function(a, b) {
        var e = b.get("offsetWidth"),
          c = b.get("offsetHeight");
        return [a.pageX - Math.round(e / 2), a.pageY - Math.round(c / 2)]
      }
    },
    ATTRS: {
      clickableRail: {
...
YUI.add("datatable-datasource", function(b, c) {
  ...
  b.extend(a, b.Plugin.Base, {
    ...
    load: function(a) {
      ...
      var e = a.datasource || this.get("datasource");
      e && e.sendRequest(a)
    },
...
YUI.add("datatable-column-widths", function(b, c) {
  ...
  b.Features.add("table", "badColWidth", {
    test: function() {
      var a = b.one("body"),
        e;
      a && (a = a.insertBefore('<table style="position:absolute;visibility:hidden;border:0 none"><colgroup><col style="width:9px"></colgroup><tbody><tr><td style="padding:0 4px;font:normal 2px/2px arial;border:0 none">.</td></tr></tbody></table>', a.get("firstChild")), e = "1px" !== a.one("td").getComputedStyle("width"), a.remove(!0));
      return e
    }
  });
  b.mix(a.prototype, {
    ...
    _setColumnWidth: function(a, e) {
      var c = this._colgroupNode,
        c = c && c.all("col").item(a),
        k, m;
      if (c && (e && d(e) && (e += "px"), c.setStyle("width", e), e && b.Features.test("table", "badColWidth") && (k = this.getCell([0, a])))) m = function(a) {
        return parseInt(k.getComputedStyle(a), 10) || 0
      }, c.setStyle("width", parseInt(e, 10) - m("paddingLeft") - m("paddingRight") - m("borderLeftWidth") - m("borderRightWidth") + "px")
    },
    _uiSetColumnWidths: function() {
      if (this.view) {
        var a = this.COL_TEMPLATE,
          b = this._colgroupNode,
          e = this._displayColumns,
          d, c;
        ...
        d = 0;
        for (c = e.length; d < c; ++d) b.append(a), this._setColumnWidth(d, e[d].width)
      }
    }
  }, !0);
  ...
  b.mix(b.DD.DDM, {
    ...
    isOverTarget: function(a) {
      if (this.activeDrag && a) {
        var b = this.activeDrag.mouseXY,
          e = this.activeDrag.get("dragMode"),
          c, f = a.shim;
        if (b && this.activeDrag) {
          c = this.activeDrag.region;
          if (e === this.STRICT) return this.activeDrag.get("dragNode").inRegion(a.region, !0, c);
          if (a && a.shim) {
            if (e === this.INTERSECT && this._noShim) return b = c || this.activeDrag.get("node"), a.get("node").intersect(b, a.region).inRegion;
            this._noShim && (f = a.get("node"));
            return f.intersect({
              top: b[1],
              bottom: b[1],
              left: b[0],
    ...
    getBestMatch: function(a, d) {
      ...
      b.Object.each(a, function(a) {
        ...
        b.inRegion && b.area > c && (c = b.area, e = a)
      }, this);
      return d ? (f = [], b.Object.each(a, function(a) {
        a !== e && f.push(a)
      }, this), [e, f]) : e
    },
    _deactivateTargets: function() {
      var a = [],
        d = this.activeDrag,
        e = this.activeDrop;
      d && e && this.otherDrops[e] ? (d.get("dragMode") ? (a = this.getBestMatch(this.otherDrops, !0), e = a[0], a = a[1]) : (a = this.otherDrops,
      delete a[e]), d.get("node").removeClass(this.CSS_PREFIX + "-drag-over"), e && (e.fire("drop:hit", {
        drag: d,
        drop: e,
        others: a
      }), d.fire("drag:drophit", {
    ...
    getDrop: function(a) {
      var d = !1,
        e = b.one(a);
      e instanceof b.Node && b.Array.each(this.targets, function(a) {
        e.compareTo(a.get("node")) && (d = a)
      });
      return d
    }
  }, !0)
...
YUI.add("squarespace-gizmo", function(b) {
  ...
  var c = RegExp("[ ]+", "g"),
    ...
    d = function(a, e, d, c, m) {
      return (m ? b.Array.reject : b.Array.filter)(a, function(a) {
        for (var b = 0; b < d.length; ++b) if (a[d[b]] !== c[b]) return !1;
        e && e(a);
        return !0
      })
    }, e = function(a, d, c, k, m) {
      if (!this._destroyed) {
        ...
        if (b.Lang.isObject(d) && b.Lang.isFunction(d[a])) {
          var l = [c, k, m || this],
            l = l.concat(Array.prototype.slice.call(arguments,
            5)),
            l = d[a].apply(d, l);
  ...
  b.Squarespace.Gizmo = Class.create({
    ...
    initialize: function(a) {
      ...
      for (var e = function(a, b) {
        this.publish(b, a)
      }; null !== a && void 0 !== a;) b.Object.each(a._events, e, this), a = a.superclass
    },
    ...
    _subscribe: function(a, d, c, k) {
      var m = ["on"].concat(b.Array(arguments));
      return e.apply(this, m)
    },
    _subscribeOnce: function(a, d, c, k) {
      var m = ["once"].concat(b.Array(arguments));
      return e.apply(this, m)
    },
    _subscribeBefore: function(a, d, c, k) {
      var m = ["before"].concat(b.Array(arguments));
      return e.apply(this, m)
    },
    _subscribeAfter: function(a, d, c, k) {
      var m = ["after"].concat(b.Array(arguments));
      return e.apply(this, m)
    },
    ...
    destroy: function() {
      if (this._destroyed) console.warn("Gizmo[" + this._name + "] already destroyed.");
        ...
        this._children = null;
        d = this._timers;
        for (a = 0; a < d.length; ++a) d[a].cancel();
        this._timers = null;
    ...
    _anim: function(a) {
      if (!this._destroyed) {
        ...
        var e;
        a.node.ancestor("body", !0) ? a.node._node ? (e = new b.Anim(a), e.on("end", function(a) {
          this._removeAnim(e)
        },
        this), this._anims.push(e)) : (console.warn("Gizmo[" + this._name + "]: _anim passed a YUI node with _node = null! Returning an empty animation."), console.trace(), e = new b.Anim) : (console.warn("Gizmo[" + this._name + "]: _anim passed a YUI node not in the DOM! Returning an empty animation."), e = new b.Anim);
        return e
      }
    },
    ...
    _trace: function(a) {
      for (var e = this.getEvent(a).getSubs(), d = [], c = function(a, b) {
        if (a.context && a.context.getName) d.push(a.context.getName());
        else {
          var e = {};
          e[a.fn.name] = a.fn.toString();
          d.push(e)
        }
      }, m = 0; m < e.length; ++m) b.Object.each(e[m], c);
      console.log("[trace] Event", a, "is notifying the following:", d);
      this.fire(a)
    },
    _later: function(a, e, d, c, m) {
      if (!this._destroyed) return a = b.later(a, d || this, e, c, m), this._timers.push(a), a
    },
    _cb: function(a) {
...
YUI.add("widget-anim", function(b, c) {
  function a(b) {
    a.superclass.constructor.apply(this, arguments)
  }
  a.NS = "anim";
  a.NAME = "pluginWidgetAnim";
  a.ANIMATIONS = {
    fadeIn: function() {
      var a = this.get("host"),
        e = a.get("boundingBox"),
      ...
      a.get("visible") || e.setStyle("opacity", 0);
      c.on("destroy", function() {
        this.get("node").setStyle("opacity", b.UA.ie ? 1 : "")
      });
      return c
    },
    fadeOut: function() {
  ...
  a.ATTRS = {
    ...
    animShow: {
      valueFn: a.ANIMATIONS.fadeIn
    },
    animHide: {
      valueFn: a.ANIMATIONS.fadeOut
    }
  };
  b.extend(a, b.Plugin.Base, {
    initializer: function(a) {
    ...
    _uiAnimSetVisible: function(a) {
      if (this.get("host").get("rendered")) return a ? (this.get("animHide").stop(), this.get("animShow").run()) : (this.get("animShow").stop(), this.get("animHide").run()), new b.Do.Prevent
    },
    _uiSetVisible: function(a) {
      var b = this.get("host"),
        c = b.getClassName("hidden");
      b.get("boundingBox").toggleClass(c, !a)
    },
    _bindAnimShow: function() {
      this.get("animShow").on("start", b.bind(function() {
        this._uiSetVisible(!0)
      }, this))
    },
    _bindAnimHide: function() {
      this.get("animHide").after("end", b.bind(function() {
        this._uiSetVisible(!1)
      }, this))
    }
  });
  b.namespace("Plugin").WidgetAnim = a
}, "3.17.2", {
...
YUI.add("squarespace-dialog", function(b) {
  ...
  b.Squarespace.EditingDialog = Class.extend(b.Squarespace.ZombieGizmo, {
    ...
    _positionWithAnchorEl: function() {
      var c, a, d, e, g = this.params.width;
      this.el.setStyle("position", this.params.forcePosition || "absolute");
      this.anchorEl.addClass("targeted");
      "left" === this.params.flyoutPointerDirection || "right" === this.params.flyoutPointerDirection ? (this.el.setStyle("width", g + this.NOTCH_HEIGHT + "px"), this.mainEl.setStyle("width", g + "px"), this.el.addClass("flyout")) : "hidden" === this.params.flyoutPointerDirection ? (this.el.setStyle("width", g + "px"), this.mainEl.setStyle("width", g + "px")) : "top" === this.params.flyoutPointerDirection ? (this._initNotchEl("top"), this.el.insertBefore(this.notchEl, this.mainEl), d = this.anchorEl.get("offsetWidth"), a = this.anchorEl.get("offsetHeight"), c = this.anchorEl.getX(), a = this.anchorEl.getY() + a, g > d && (c -= (g - d) / 2), this.currentXY = [c, a - 3], this.notchEl.setStyle("marginLeft", (g - 30) / 2 + "px"), d = this.params.left || this.currentXY[0], e = this.params.top || this.currentXY[1], this.el.setStyles({
        left: d + "px",
        top: e + "px",
        width: g + "px"
      }), this.mainEl.setStyle("width", g + "px")) : "bottom" === this.params.flyoutPointerDirection ? (this._initNotchEl("top", "bottom"), this.el.append(this.notchEl), d = this.anchorEl.get("offsetWidth"), a = this.anchorEl.get("offsetHeight"), c = this.anchorEl.getX(), a = this.anchorEl.getY() + a, g > d && (c -= (g - d) / 2), this.currentXY = [c, a - 3], this.notchEl.setStyle("marginLeft", (g - 30) / 2 + "px"), d = this.params.left || this.currentXY[0], e = this.params.top || this.currentXY[1], this.el.setStyles({
        left: d + "px",
        top: e + "px",
        width: g + "px"
      }), this.mainEl.setStyle("width", g + "px")) : (this.currentXY = [this.anchorEl.getX() + (this.anchorEl.get("offsetWidth") - g) / 2, this.anchorEl.getY() + (this.anchorEl.get("offsetHeight") - this.params.height) / 2 - 15], this.el.setStyles({
        left: this.currentXY[0] + "px",
        top: this.currentXY[1] + "px",
        width: g + "px"
      }), this.el.setStyle(), this.mainEl.setStyle("width", g + "px"), a = this.currentXY[1]);
    ...
    _alignNotch: function(b) {
      if (this.notchEl) {
        ...
        b = b.get("region");
        var g = b.top + b.height / 2;
        b.top > e.top && (d = g - e.top - 11, d = Math.min(a, Math.max(12, d)));
    ...
    setInitialData: function(c) {
      ...
      this.fields && b.Object.each(this.fields, function(a, d) {
    ...
    moveIntoView: function(c) {
      if (this.params.draggable) {
        ...
        var a = {}, d = this.el.get("docScrollX"),
          ...
          g = this.el.get("winWidth") + d,
          f = this.el.get("winHeight"),
          h = f + e,
          k = this.el.getY(),
          m = this.el.getX();
        k < e && (a.top = e);
        k + this.el.get("offsetHeight") > h && (a.top = h - this.el.get("offsetHeight"));
        m + this.el.get("offsetWidth") > g && (a.left = g - this.el.get("offsetWidth"));
        m < d && (a.left = d);
        c && (a.top = a.top ? Math.max(a.top, this.position.getY()) : this.position.getY());
        "fixed" === this.params.forcePosition && (b.Lang.isValue(a.top) && a.top > this.el.get("winHeight")) && (a.top = Math.max(0, f - this.el.get("offsetHeight")));
        ...
        this.preferredHeight + 120 > f ? (this.bodyHeight = f - 120, this.bodyEl.setHeight(this.bodyHeight)) : this.bodyHeight != this.preferredHeight && (this.bodyHeight = this.preferredHeight, this.bodyEl.setHeight(this.preferredHeight))
      }
    },
    ...
    showErrors: function(c) {
      ...
      b.Object.each(c, function(a, b) {
        var e = this.getField(b);
        e || console.error("Server error returned for a missing dialog field: " + b);
        e.tab.tabNavigationObj && e.tab.tabNavigationObj.addClass("error");
        this.errorsByTab[e.tab.name] ? this.errorsByTab[e.tab.name]++ : this.errorsByTab[e.tab.name] = 1
      }, this);
      this.activateErrors()
    },
    ...
    _showPanelByIndex: function(c) {
      if (c != this.currentTabIndex) {
        var a, d = b.Easing.easeBothStrong,
          ...
          g = this.params.tabs[this.currentTabIndex];
        this.params.noTabAnim || (e.tabPanelObj.animation && e.tabPanelObj.animation.stop(!0), g.tabPanelObj.animation && g.tabPanelObj.animation.stop(!0));
        a = g.tabFields;
        this.params.noTabAnim ? (g.tabPanelObj.setStyles({
          opacity: 1,
          zIndex: "300"
        }), g.tabPanelObj.addClass("hidden")) : (e.tabPanelObj.setStyles({
          left: (e.index > g.index ? 1 : -1) * this.params.width + "px",
          opacity: 1,
          zIndex: "300"
        }), g.tabPanelObj.setStyle("zIndex", "0"), a = this._anim({
          node: g.tabPanelObj,
          to: {
            left: (e.index < g.index ? 1 : -1) * this.params.width + "px"
          },
          ...
          tab: g.tabPanelObj
        }), a.run(), g.tabPanelObj.animation = a);
        this.currentTab = e;
        ...
        this.currentTab.height && (this.currentTab.tabPanelObj.setStyle("height", g.height - 50), this._anim({
          node: this.bodyEl,
          to: {
    ...
    _showLocalErrors: function() {
      ...
      b.Array.map(e, function(a) {
        ...
        var b = a.errors;
        b[b.length - 1] && (f[a.field.getName()] = b[b.length - 1], g = !0)
      }, this);
      g && this.showErrors(f);
      return g
    },
    ...
    getErrors: function() {
      ...
      for (d in this.fields) {
        var e = this.fields[d],
          g = !1;
        if (g = this._isDialogField2(e) ? e.get("required") && e.isEmpty() : e.config.required && ("" === e.getValue() || 0 === e.getValue())) a[e.getName()] = "This is a required field.", b++
      }
      return {
        errors: b,
        errorSet: a
    ...
    _recordFieldData: function(c, a) {
      b.Object.each(a.fields, function(a) {
        if (b.Lang.isFunction(a.getValue)) {
          var e = a.getValue();
          c[a.getName()] = e;
          if (void 0 !== a.getAssociatedVars) for (var e = a.getAssociatedVars(), g = 0; g < e.length; g++) c[e[g].name] = e[g].value
        }
    ...
    _renderFields: function(c, a, d, e) {
      b.Array.each(a, function(g, f) {
        var h;
        if (g) {
          var k = g.type;
          !e && !this.params.dontSetWidthOnFields && (e = this.params.width - 60);
          e && !isNaN(e) && (this._debug.log("availableWidth: ", e),
          this._debug.log("fieldConfig.width: ", g.width), h = (g.ctor && g.config ? g.config.width : g.width) || 1, h = 1 >= h ? Math.floor(h * e) : h);
          "splitter" === k ? this._renderSplitter(g, f, a, c, d, e, h) : "multi-frame" === k ? this._renderMultiFrame(g, f, a, c, d, e, h) : "section" === k ? this._renderSection(g, f, a, c, d, e, h) : "stack" === k ? this._renderStack(g, f, a, c, d, e, h) : g.ctor && g.ctor === b.Squarespace.DialogFields.MultiFrame ? this._renderDF2MultiFrame(g, f, a, c, d, e, h) : this._renderField(g, f, a, c, d, e, h)
        }
      }, this)
    },
    _renderSplitter: function(c, a, d, e, g, f, h) {
      a = b.Node.create('<div class="split-field clear ' + (1 < c.fields.length ? "padding-adjust" : "") + '"></div>');
      c.width || (c.width = 1);
      f && !isNaN(f) ? (a.setStyle("width", Math.round(c.width * f) + 30 + "px"), f -= 30 * (c.fields.length - 1)) : f = g.get("offsetWidth") - 30 * (c.fields.length - 1) - 60;
      g.append(a);
      this._renderFields(e, c.fields, a, f);
      c.countHeight && (this._takenHeight += a.get("offsetHeight"));
      c.hidden && a.hide()
    },
    _renderMultiFrame: function(c, a, d, e, g, f, h) {
    ...
    _renderDF2MultiFrame: function(c, a, d, e, g, f, h) {
      ...
      c = new c.ctor(a);
      f && c.get("boundingBox").setStyle("width", h + "px");
      (f = c.getName() || c.get("name")) ? this.fields[f] = c : this._noNameFields.push(c);
      c.each(function(a) {
    ...
    _renderSection: function(c, a, d, e, g, f, h) {
      ...
      g.append(d);
      c.width || (c.width = 1);
      (g = Math.round(c.width * f)) && d.setStyle("width", g + "px");
      f = Math.round(c.width * f);
      this._renderFields(e, c.fields, a, f);
      c.hidden && d.hide();
      c.name && (this.sections[c.name] = d)
    },
    _renderStack: function(c, a, d, e, g, f, h) {
      (h = f) || (h = this.params.width - 60);
      f = b.Node.create('<div class="stack-field stack-field-wrapper clear"></div>');
      g.append(f);
      c.width || (c.width = 1);
      c["float"] && f.setStyle("float", c["float"]);
      f.setStyle("width", Math.round(c.width * h) + "px");
      a !== d.length - 1 && f.setStyle("paddingRight", "30px");
      a = Math.round(c.width * h);
      this._renderFields(e, c.fields, f, a);
      c.hidden && f.hide();
      c.name && (this.sections[c.name] = f)
    },
    _renderField: function(c, a, d, e, g, f, h) {
      var k;
      a = b.merge(c, c.config || {}, {
        dialog: this,
        render: g
      ...
      if (c.ctor) k = new c.ctor(a);
        ...
        var m = this._convertToDialogField2Name(c.type),
          m = b.namespace("Squarespace.DialogFields")[m];
        if (!m && !b.Squarespace.DialogFieldGenerators[c.type]) throw "Unknown field type: " + c.type;
        this._debug.log("Generating field type: ", c.type);
        m ? k = new m(a) : (k = new b.Squarespace.DialogFieldGenerators[c.type](c, this.params.initialData, this), k.type = c.type, k.append(g))
      }
      ...
      10)));
      f && (this._isDialogField2(k) ? (this._debug.log("setting width", h), k.get("boundingBox").setStyle("width", h + "px")) : k.html && (this._debug.log("setting width", h), k.html.setStyle("width", h + "px")));
      k.resize && k.resize();
    ...
    renderTab: function(c, a) {
      ...
      if (this._verticalEl) {
        ...
        this._takenHeight += e;
        var g = this._isDialogField2(this._verticalEl);
        !g && !this._verticalEl.setHeight && console.error("No setHeight for vertical el: ", this._verticalEl);
        e = this.getBodyHeight() - this._takenHeight;
        g ? (g = this._verticalEl.get("boundingBox"), e -= parseInt(g.getStyle("marginTop"), 10), e -= parseInt(g.getStyle("marginBottom"), 10), this._verticalEl.set("height", e)) : this._verticalEl.setHeight(e);
...
YUI.add("widget-child", function(b, c) {
  function a() {
    b.after(this._syncUIChild, this, "syncUI");
    b.after(this._bindUIChild, this, "bindUI")
  }
  var d = b.Lang;
  a.ATTRS = {
    selected: {
  ...
  a.prototype = {
    ...
    previous: function(a) {
      var b = this.get("parent"),
        ...
        c;
      b && 0 < d && (c = b.item([d - 1]));
      !c && a && (c = b.item(b.size() - 1));
      return c
    },
    remove: function(a) {
      var c, f;
      d.isNumber(a) ? f = b.WidgetParent.prototype.remove.apply(this, arguments) : (c = this.get("parent")) && (f = c.remove(this.get("index")));
      return f
    },
    isRoot: function() {
...
YUI.add("datatable-body", function(b, c) {
  ...
  b.namespace("DataTable").BodyView = b.Base.create("tableBody", b.View, [], {
    ...
    getCell: function(a, e) {
      var c = this.tbodyNode,
        f, h, k;
      a && c && (d(a) ? h = (f = c.get("children").item(a[0])) && f.get("children").item(a[1]) : a._node && (h = a.ancestor("." + this.getClassName("cell"), !0)), h && e && (f = c.get("firstChild.rowIndex"), g(e) && (n[e] || b.error("Unrecognized shift: " + e, null, "datatable-body"), e = n[e]), d(e) && (k = h.get("parentNode.rowIndex") + e[0] - f, f = c.get("children").item(k), k = h.get("cellIndex") + e[1], h = f && f.get("children").item(k))));
      return h || null
    },
    getClassName: function() {
      var a = this.host;
    ...
    getRecord: function(a) {
      var b = this.get("modelList"),
        ...
        d = null,
        c;
      e && (g(a) && (a = e.one("#" + a)), a && a._node && (c = (d = a.ancestor(function(a) {
        return a.get("parentNode").compareTo(e)
    ...
    getRow: function(a) {
      var b = this.tbodyNode,
        d = null;
      b && (a && (a = this._idMap[a.get ? a.get("clientId") : a] || a), d = e(a) ? b.get("children").item(a) : b.one("#" + a));
      return d
    },
    render: function() {
      ...
      this._createRowTemplate(e);
      b && (d.setHTML(this._createDataHTML(e)), this._applyNodeFormatters(d, e));
      d.get("parentNode") !== a && a.appendChild(d);
      this.bindUI();
      return this
    },
    refreshRow: function(a, b, e) {
      var d, c = e.length,
        g;
      for (g = 0; g < c; g++) d = this.getColumn(e[g]), null !== d && (d = a.one("." + this.getClassName("col", d._id || d.key)), this.refreshCell(d,
      b));
      return this
    },
    refreshCell: function(a, e, d) {
      var c, g, f = e.toJSON();
      a = this.getCell(a);
      e || (e = this.getRecord(a));
      d || (d = this.getColumn(a));
      if (d.nodeFormatter) e = {
        ...
        td: a,
        value: f[d.key]
      }, keep = d.nodeFormatter.call(host, e), !1 === keep && a.destroy(!0);
      else if (d.formatter) {
        d._formatterFn || (d = this._setColumnsFormatterFn([d])[0]);
        if (g = d._formatterFn || null) e = {
          value: f[d.key],
          data: f,
          column: d,
          record: e,
          ...
          rowClass: "",
          rowIndex: this._getRowIndex(a.ancestor("tr"))
        }, c = g.call(this.get("host"), e), void 0 === c && (c = e.value);
        if (void 0 === c || null === c || "" === c) c = d.emptyCellValue || ""
      } else c = f[d.key] || d.emptyCellValue || "";
      a.setHTML(d.allowHTML ? c : b.Escape.html(c));
      return this
    },
    getColumn: function(a) {
      ...
      var d = this.get("columns"),
        e = null;
      b.Array.some(d, function(b) {
        if ((b._id || b.key) === a) return e = b, !0
      });
      return e
    },
    ...
    _afterDataChange: function(a) {
      var d = (a.type.match(/:(add|change|remove)$/) || [])[1],
        e = a.index,
        c = this.get("columns"),
        g, f = a.changed && b.Object.keys(a.changed),
        h, k;
      h = 0;
      for (k = c.length; h < k; h++) if (g = c[h], g.hasOwnProperty("nodeFormatter")) {
        this.render();
      ...
      case "change":
        h = 0;
        for (k = c.length; h < k; h++) g = c[h], e = g.key, g.formatter && !a.changed[e] && f.push(e);
        this.refreshRow(this.getRow(a.target), a.target, f);
        break;
      case "add":
        e = Math.min(e, this.get("modelList").size() - 1);
        this._setColumnsFormatterFn(c);
        a = b.Node.create(this._createRowHTML(a.model, e, c));
        this.tbodyNode.insert(a, e);
        this._restripe(e);
        break;
      case "remove":
        this.getRow(e).remove(!0);
        this._restripe(e - 1);
        break;
      default:
        this.render()
    ...
    _restripe: function(a) {
      var b = this._restripeTask,
        e;
      a = Math.max(a | 0, 0);
      b ? b.index = Math.min(b.index, a) : (e = this, this._restripeTask = {
        timer: setTimeout(function() {
          if (e && !e.get("destroy") && e.tbodyNode && e.tbodyNode.inDoc()) {
            var a = [e.CLASS_ODD, e.CLASS_EVEN],
              b = [e.CLASS_EVEN, e.CLASS_ODD],
              d = e._restripeTask.index;
            e.tbodyNode.get("childNodes").slice(d).each(function(e, c) {
              e.replaceClass.apply(e, (d + c) % 2 ? b : a)
            })
          }
          e._restripeTask = null
        }, 0),
        index: a
      })
    },
    ...
    _applyNodeFormatters: function(a, b) {
      var e = this.host || this,
        d = this.get("modelList"),
        c = [],
        g = "." + this.getClassName("liner"),
        f, h, k;
      h = 0;
      for (k = b.length; h < k; ++h) b[h].nodeFormatter && c.push(h);
      d && c.length && (f = a.get("childNodes"), d.each(function(a, d) {
        var h = {
          data: a.toJSON(),
          record: a,
          rowIndex: d
        ...
        if (k) {
          n = k.get("childNodes");
          k = 0;
          for (m = c.length; k < m; ++k) if (s = n.item(c[k])) l = h.column = b[c[k]], p = l.key || l.id, h.value = a.get(p), h.td = s, h.cell = s.one(g) || s, l = l.nodeFormatter.call(e, h), !1 === l && s.destroy(!0)
        }
      }))
    },
    bindUI: function() {
      var a = this._eventHandles,
        b = this.get("modelList"),
        e = b.model.NAME + ":change";
      a.columnsChange || (a.columnsChange = this.after("columnsChange", m("_afterColumnsChange", this)));
      b && !a.dataChange && (a.dataChange = b.after(["add", "remove", "reset", e], m("_afterDataChange", this)))
    },
    _createDataHTML: function(a) {
      var b = this.get("modelList"),
        e = "";
      b && b.each(function(b, d) {
        e += this._createRowHTML(b, d, a)
      }, this);
      return e
    },
    _createRowHTML: function(a, b, e) {
      var d = a.toJSON(),
        c = a.get("clientId"),
        c = {
          rowId: this._getRowId(c),
          clientId: c,
          rowClass: b % 2 ? this.CLASS_ODD : this.CLASS_EVEN
        }, g = this.host || this,
        k, m, l, p, n, A;
      k = 0;
      for (m = e.length; k < m; ++k) if (l = e[k], n = d[l.key], p = l._id || l.key, c[p + "-className"] = "", l._formatterFn && (A = {
        value: n,
        data: d,
        column: l,
        record: a,
        ...
        rowClass: "",
        rowIndex: b
      }, n = l._formatterFn.call(g, A), void 0 === n && (n = A.value), c[p + "-className"] = A.className, c.rowClass += " " + A.rowClass), !c.hasOwnProperty(p) || d.hasOwnProperty(l.key)) {
        if (void 0 === n || null === n || "" === n) n = l.emptyCellValue || "";
        c[p] = l.allowHTML ? n : h(n)
      }
      c.rowClass = c.rowClass.replace(/\s+/g, " ");
      return f(this._rowTemplate, c)
    },
    ...
    _createRowTemplate: function(a) {
      var b = "",
        e = this.CELL_TEMPLATE,
        d, c, g, h, k, m;
      this._setColumnsFormatterFn(a);
      d = 0;
      for (c = a.length; d < c; ++d) g = a[d], h = g.key, k = g._id || h, h = g._formatterFn, m = 1 < (g._headers || []).length ? 'headers="' + g._headers.join(" ") + '"' : "", k = {
        content: "{" + k + "}",
        headers: m,
        className: this.getClassName("col", k) + " " + (g.className || "") + " " + this.getClassName("cell") + " {" + k + "-className}"
      }, !h && g.formatter && (k.content = g.formatter.replace(p,
      k.content)), g.nodeFormatter && (k.content = ""), b += f(g.cellTemplate || e, k);
      this._rowTemplate = f(this.ROW_TEMPLATE, {
        content: b
      })
    },
    _setColumnsFormatterFn: function(e) {
      var d = b.DataTable.BodyView.Formatters,
        c, g, f, h;
      f = 0;
      for (h = e.length; f < h; f++) g = e[f], c = g.formatter, !g._formatterFn && c && (a.isFunction(c) ? g._formatterFn = c : c in d && (g._formatterFn = d[c].call(this.host || this, g)));
      return e
    },
    _createTBodyNode: function() {
      return b.Node.create(f(this.TBODY_TEMPLATE, {
        className: this.getClassName("data")
      }))
    },
    destructor: function() {
      (new b.EventHandle(l.values(this._eventHandles))).detach()
    },
    ...
    initializer: function(a) {
      this.host = a.host;
      this._eventHandles = {
        modelListChange: this.after("modelListChange", m("_afterModelListChange", this))
      };
      this._idMap = {};
  ...
  b.namespace("Squarespace.Animations").Flyout = b.Base.create("flyoutPlugin", b.Plugin.Base, [], {
    ...
    _animateFlyout: function(c) {
      ...
      var e = this._measureNode(d),
        g = this._getInitialFlyoutOffset();
      this._updateMaskPosition();
...
YUI.add("node-focusmanager", function(b, c) {
  ...
  f.ATTRS = {
    ...
    activeDescendant: {
      setter: function(a) {
        var d = e.isNumber,
          c = b.Attribute.INVALID_VALUE,
          g = this._descendantsMap,
          f = this._descendants,
          n;
        d(a) ? a = n = a : a instanceof b.Node && g ? (n = g[a.get("id")], a = d(n) ? n : c) : a = c;
        f && (f = f.item(n)) && f.get("disabled") && (a = c);
        return a
      }
    },
    keys: {
  ...
  b.extend(f, b.Plugin.Base, {
    ...
    _initDescendants: function() {
      var a = this.get("descendants"),
        d = {}, c = -1,
        g, f = this.get("activeDescendant"),
        n, s, r = 0;
      e.isUndefined(f) && (f = -1);
      if (a) {
        g = a.size();
        for (r = 0; r < g; r++) n = a.item(r), - 1 === c && !n.get("disabled") && (c = r), 0 > f && 0 === parseInt(n.getAttribute("tabIndex", 2),
        10) && (f = r), n && n.set("tabIndex", - 1), s = n.get("id"), s || (s = b.guid(), n.set("id", s)), d[s] = r;
        0 > f && (f = 0);
        n = a.item(f);
        if (!n || n.get("disabled")) n = a.item(c), f = c;
        this._lastNodeIndex = g - 1;
        this._descendants = a;
        this._descendantsMap = d;
        this.set("activeDescendant", f);
        n && n.set("tabIndex", 0)
      }
    },
    ...
    _removeFocusClass: function() {
      var a = this._focusedNode,
        ...
        d;
      b && (d = e.isString(b) ? b : b.className);
      a && d && a.removeClass(d)
    },
    ...
    _fireClick: function(a) {
      var b = a.target,
        e = b.get("nodeName").toLowerCase();
      13 === a.keyCode && (!d[e] || "a" === e && !b.getAttribute("href")) && b.simulate("click")
    },
    _attachKeyHandler: function() {
      this._detachKeyHandler();
      var a = this.get("keys.next"),
        e = this.get("keys.previous"),
        d = this.get("host"),
        c = this._eventHandlers;
      e && (this._prevKeyHandler = b.on("key",
      b.bind(this._focusPrevious, this), d, e));
      a && (this._nextKeyHandler = b.on("key", b.bind(this._focusNext, this), d, a));
      g.opera && c.push(d.on("keypress", this._preventScroll, this));
      g.opera || c.push(d.on("keypress", this._fireClick, this))
    },
    ...
    _attachEventHandlers: function() {
      var a = this._descendants,
        e, d;
      a && a.size() && (a = this._eventHandlers || [], e = this.get("host").get("ownerDocument"),
      0 === a.length && (a.push(e.on("focus", this._onDocFocus, this)), a.push(e.on("mousedown", this._onDocMouseDown, this)), a.push(this.after("keysChange", this._attachKeyHandler)), a.push(this.after("descendantsChange", this._initDescendants)), a.push(this.after("activeDescendantChange", this._afterActiveDescendantChange)), d = this.after("focusedChange", b.bind(function(a) {
    ...
    _onDocMouseDown: function(a) {
      var b = this.get("host"),
        ...
        c, f = function(a) {
          var e = !1;
          a.compareTo(b) || (e = this._isDescendant(a) ? a : f.call(this, a.get("parentNode")));
          return e
        };
      d && ((c = f.call(this, e)) ? e = c : !c && this.get("focused") && (this._set("focused", !1), this._onDocFocus(a)));
      if (d && this._isDescendant(e)) this.focus(e);
      else if (g.webkit && this.get("focused") && (!d || d && !this._isDescendant(e))) this._set("focused", !1), this._onDocFocus(a)
    },
    _onDocFocus: function(a) {
      a = this._focusTarget || a.target;
      var b = this.get("focused"),
        e = this.get("focusClass"),
        d = this._focusedNode,
        c;
      this._focusTarget && (this._focusTarget = null);
      this.get("host").contains(a) ? (c = this._isDescendant(a), !b && c ? b = !0 : b && !c && (b = !1)) : b = !1;
      e && (d && (!d.compareTo(a) || !b) && this._removeFocusClass(), c && b && (e.fn ? (a = e.fn(a), a.addClass(e.className)) : a.addClass(e), this._focusedNode = a));
      this._set("focused", b)
    },
    _focusNext: function(a, b) {
      var e = b || this.get("activeDescendant"),
        d;
      this._isDescendant(a.target) && e <= this._lastNodeIndex && (e += 1, e === this._lastNodeIndex + 1 && this.get("circular") && (e = 0), (d = this._descendants.item(e)) && (d.get("disabled") ? this._focusNext(a, e) : this.focus(e)));
      this._preventScroll(a)
    },
    _focusPrevious: function(a, b) {
      var e = b || this.get("activeDescendant"),
        d;
      this._isDescendant(a.target) && 0 <= e && (e -= 1, - 1 === e && this.get("circular") && (e = this._lastNodeIndex), (d = this._descendants.item(e)) && (d.get("disabled") ? this._focusPrevious(a, e) : this.focus(e)));
      this._preventScroll(a)
    },
    ...
    focus: function(a) {
      ...
      if (a = this._descendants.item(this.get("activeDescendant"))) a.focus(), g.opera && "button" === a.get("nodeName").toLowerCase() && (this._focusTarget = a)
    },
    blur: function() {
      var a;
      if (this.get("focused")) {
  ...
  f.NAME = "nodeFocusManager";
  f.NS = "focusManager";
  b.namespace("Plugin");
  b.Plugin.NodeFocusManager = f
}, "3.17.2", {
  ...
  b.extend(d, b.Base, {
    ...
    _init: function() {
      if (a._proxy) {
        ...
        var e, d, c = this.get("host");
        c.get("dragNode").compareTo(c.get("node")) && a._proxy && c.set("dragNode", a._proxy);
        b.Array.each(this._hands, function(a) {
          a.detach()
        });
        e = a.on("ddm:start", b.bind(function() {
          a.activeDrag === c && a._setFrame(c)
        }, this));
        d = a.on("ddm:end", b.bind(function() {
          c.get("dragging") && (this.get("moveOnEnd") && c.get("node").setXY(c.lastXY), this.get("hideOnEnd") && c.get("dragNode").setStyle("display", "none"), this.get("cloneNode") && (c.get("dragNode").remove(), c.set("dragNode", a._proxy)))
        }, this));
        this._hands = [e, d]
...
YUI.add("datatable-head", function(b, c) {
  ...
  b.namespace("DataTable").HeaderView = b.Base.create("tableHeader", b.View, [], {
    ...
    getClassName: function() {
      var a = this.host,
        e = a && a.constructor.NAME || this.constructor.NAME;
      return a && a.getClassName ? a.getClassName.apply(a,
      arguments) : b.ClassNameManager.getClassName.apply(b.ClassNameManager, [e].concat(g(arguments, 0, !0)))
    },
    render: function() {
      var a = this.get("container"),
        e = this.theadNode || (this.theadNode = this._createTHeadNode()),
        c = this.columns,
        g = {
          _colspan: 1,
          _rowspan: 1,
      ...
      if (e && c) {
        ...
        if (c.length) {
          ...
          for (p = c.length; l < p; ++l) {
            t = "";
            n = 0;
            for (s = c[l].length; n < s; ++n) r = c[l][n], x = b.merge(g, r, {
              className: this.getClassName("header"),
              content: r.label || r.key || "Column " + (n + 1)
            }), x._id = r._id ? ' data-yui3-col-id="' + r._id + '"' : "", r.abbr && (x.abbr = ' abbr="' + r.abbr + '"'), r.title && (x.title = ' title="' + r.title + '"'), r.className && (x.className += " " + r.className), r._first && (x.className += " " + this.getClassName("first", "header")), r._id && (x.className += " " + this.getClassName("col", r._id)), t += d(r.headerTemplate || this.CELL_TEMPLATE, x);
        ...
        e.setHTML(q);
        e.get("parentNode") !== a && a.insertBefore(e, a.one("tfoot, tbody"))
      }
      this.bindUI();
      return this
    },
    ...
    _parseColumns: function(a) {
      ...
      if (e(a) && a.length) {
        ...
        for (c.push([a, - 1]); c.length;) {
          ...
          p = l[0];
          q = l[1] + 1;
          for (t = p.length; q < t; ++q) if (p[q] = n = b.merge(p[q]), s = n.children, b.stamp(n), n.id || (n.id = b.guid()), e(s) && s.length) {
            c.push([s, - 1]);
            l[1] = q;
            g = Math.max(g, c.length);
            break
          } else n._colspan = 1;
          if (q >= t) {
            if (1 < c.length) {
              ...
              r = l[0][l[1]];
              q = r._colspan = 0;
              for (t = p.length; q < t; ++q) p[q]._parent = r, r._colspan += p[q]._colspan
            }
            c.pop()
          }
        }
        for (q = 0; q < g; ++q) d.push([]);
        for (c.push([a, - 1]); c.length;) {
          l = c[c.length - 1];
          p = l[0];
          q = l[1] + 1;
          for (t = p.length; q < t; ++q) {
            n = p[q];
            s = n.children;
            d[c.length - 1].push(n);
            l[1] = q;
            n._headers = [n.id];
            for (a = c.length - 2; 0 <= a; --a) r = c[a][0][c[a][1]], n._headers.unshift(r.id);
            if (s && s.length) {
              c.push([s, - 1]);
              break
            } else n._rowspan = g - c.length + 1
          }
          q >= t && c.pop()
        }
      }
      q = 0;
      for (t = d.length; q < t; q += n._rowspan) n = d[q][0], n._first = !0;
      return d
    }
  })
}, "3.17.2", {
...
YUI.add("widget-parent", function(b, c) {
  function a(a) {
    ...
    this._items = [];
    var d, c;
    a && a.children && (d = a.children, c = this.after("initializedChange", function(a) {
      this._add(d);
      c.detach()
    }));
    b.after(this._renderChildren, this, "renderUI");
    b.after(this._bindUIParent, this, "bindUI");
  ...
  a.ATTRS = {
    defaultChildType: {
      setter: function(a) {
        var c = b.Attribute.INVALID_VALUE;
        a = d.isString(a) ? b[a] : a;
        d.isFunction(a) && (c = a);
        return c
      }
    },
    ...
    selection: {
      ...
      getter: function(a) {
        return d.isArray(a) ? new b.ArrayList(a) : a
      }
    },
    selected: {
      setter: function(a) {
        var d = a;
        1 === a && !this.get("multiple") && (d = b.Attribute.INVALID_VALUE);
        return d
      }
    }
  };
  a.prototype = {
    ...
    _afterSelectionChange: function(a) {
      if (a.target == this && a.src != this) {
        a = a.newVal;
        var d = 0;
        a && (d = 2, b.instanceOf(a,
        b.ArrayList) && a.size() === this.size() && (d = 1));
        this.set("selected", d, {
          src: this
        })
      }
    ...
    _createChild: function(a) {
      var c = this.get("defaultChildType"),
        f = a.childType || a.type,
        h, k, m;
      f && (k = d.isString(f) ? b[f] : f);
      d.isFunction(k) ? m = k : c && (m = c);
      m ? h = new m(a) : b.error("Could not create a child instance because its constructor is either undefined or invalid.");
      return h
    },
    _defAddChildFn: function(a) {
      var c = a.child,
        f = a.index,
        h = this._items;
      c.get("parent") && c.remove();
      d.isNumber(f) ? h.splice(f, 0, c) : h.push(c);
      c._set("parent", this);
      c.addTarget(this);
      a.index = c.get("index");
      c.after("selectedChange", b.bind(this._updateSelection, this))
    },
    ...
    _add: function(a, c) {
      var f, h, k;
      d.isArray(a) ? (f = [], b.each(a, function(a, b) {
        (h = this._add(a, c + b)) && f.push(h)
      }, this), 0 < f.length && (k = f)) : (h = b.instanceOf(a, b.Widget) ? a : this._createChild(a)) && this.fire("addChild", {
        child: h,
        index: c
      }) && (k = h);
      return k
    ...
    add: function() {
      var a = this._add.apply(this, arguments),
        a = a ? d.isArray(a) ? a : [a] : [];
    ...
    removeAll: function() {
      var a = [],
        d;
      b.each(this._items.concat(), function() {
        (d = this.remove(0)) && a.push(d)
      }, this);
      return new b.ArrayList(a)
    },
    ...
    _uiAddChild: function(a, b) {
      ...
      var d = a.get("boundingBox"),
        c;
      (c = a.next(!1)) && c.get("rendered") ? (c = c.get("boundingBox"),
      c.insert(d, "before")) : (c = a.previous(!1)) && c.get("rendered") ? (c = c.get("boundingBox"), c.insert(d, "after")) : b.contains(d) || b.appendChild(d)
    },
...
YUI.add("view", function(b, c) {
  ...
  b.View = b.extend(a, b.Base, {
    ...
    attachEvents: function(a) {
      ...
      this.detachEvents();
      a || (a = this.events);
      for (m in a) if (c(a, m)) for (k in h = a[m], h) c(h, k) && (f = h[k], "string" === typeof f && (f = this[f]), f && this._attachedViewEvents.push(e.delegate(k, f, m, this)));
      return this
    },
    create: function(a) {
...
YUI.add("datatable-mutable", function(b, c) {
  var a = b.Array,
    ...
    k = b.Array.indexOf,
    m;
  b.namespace("DataTable").Mutable = m = function() {};
  m.ATTRS = {
    autoSync: {
      value: !1,
      validator: d.isBoolean
  ...
  b.mix(m.prototype, {
    addColumn: function(a, b) {
      ...
      if (a) {
        if (2 > arguments.length || !h(b) && !g(b)) b = this.get("columns").length;
        this.fire("addColumn", {
          column: a,
          index: b
        })
    ...
    moveColumn: function(a, b) {
      void 0 !== a && (h(b) || g(b)) && this.fire("moveColumn", {
        column: a,
        index: b
      });
      return this
    ...
    addRow: function(b, d) {
      var e = d && "sync" in d ? d.sync : this.get("autoSync"),
        c, g, f, h;
      if (b && this.data && (c = this.data.add.apply(this.data, arguments), e)) {
        c = a(c);
        h = a(arguments, 1, !0);
        g = 0;
        for (f = c.length; g < f; ++g) e = c[g], e.isNew() && c[g].save.apply(c[g], h)
      }
      return this
    },
    removeRow: function(b, d) {
      var e = this.data,
        c = d && "sync" in d ? d.sync : this.get("autoSync"),
        g, h, k;
      f(b) && b instanceof this.get("recordType") ? g = b : e && void 0 !== b && (g = e.getById(b) || e.getByClientId(b) || e.item(b));
      if (g && (k = a(arguments, 1, !0), e = e.remove.apply(e, [g].concat(k)), c)) {
        f(k[0]) || k.unshift({});
        k[0]["delete"] = !0;
        e = a(e);
        c = 0;
        for (h = e.length; c < h; ++c) g = e[c], g.destroy.apply(g, k)
      }
      return this
    },
    modifyRow: function(b, d, e) {
      var c = this.data,
        g = e && "sync" in e ? e.sync : this.get("autoSync"),
        h;
      f(b) && b instanceof this.get("recordType") ? h = b : c && void 0 !== b && (h = c.getById(b) || c.getByClientId(b) || c.item(b));
      h && f(d) && (c = a(arguments, 1, !0), h.setAttrs.apply(h, c), g && !h.isNew() && h.save.apply(h, c));
      return this
    },
    _defAddColumnFn: function(b) {
      var d = a(b.index),
        ...
        g, f;
      g = 0;
      for (f = d.length - 1; c && g < f; ++g) c = c[d[g]] && c[d[g]].children;
      c && (c.splice(d[g], 0, b.column), this.set("columns", e, {
        originEvent: b
      }))
    },
    _defModifyColumnFn: function(a) {
      var d = this.get("columns"),
        e = this.getColumn(a.column);
      e && (b.mix(e, a.newColumnDef, !0), this.set("columns", d, {
        originEvent: a
      }))
    },
    _defMoveColumnFn: function(b) {
      var d = this.get("columns"),
        e = this.getColumn(b.column),
        c = a(b.index),
        g, f, h, m, z;
      if (e && (g = e._parent ? e._parent.children : d, f = k(g, e), - 1 < f)) {
        h = d;
        m = 0;
        for (z = c.length - 1; h && m < z; ++m) h = h[c[m]] && h[c[m]].children;
        h && (z = h.length, g.splice(f, 1), c = c[m], z > h.lenth && f < c && c--, h.splice(c, 0, e), this.set("columns", d, {
          originEvent: b
        }))
      }
    },
    _defRemoveColumnFn: function(a) {
      var d = this.get("columns"),
        e = this.getColumn(a.column),
        c;
      e && (c = e._parent ? e._parent.children : d, e = b.Array.indexOf(c, e), - 1 < e && (c.splice(e,
  ...
  m.prototype.addRows = m.prototype.addRow;
  d.isFunction(b.DataTable) && b.Base.mix(b.DataTable, [m])
}, "3.17.2", {
  requires: ["datatable-base"]
});
  ...
  var c = b.Squarespace.Widgets.StructuredInput = b.Base.create("structuredInput", b.Squarespace.Widgets.SSWidget, [b.WidgetChild], {
    ...
    _handleTextInput: function(a) {
      var d = a.keyCode,
        e = this.hasSel();
      this._pauseBlink();
      if ((8 === d || 46 === d) && e) this.deleteSelection();
      else if (a.shiftKey && !e && (this.selEnd = this.selStart = this.cursorPos), 8 === d) this.deleteChars(this.cursorPos - 1, 1);
      else if (46 === d) this.deleteChars(this.cursorPos, 1);
      else if (65 === d && a.metaKey) this.selStart = this.cursorPos = 0, this.selEnd = this.length(), this._updateCursor();
      else if (38 === d) this.cursorPos = 0, a.shiftKey ? this.selEnd = this.cursorPos : e && this._clearSel(), this.movingLeft = !0, this._updateCursor();
      else if (40 === d) this.cursorPos = this.length(), a.shiftKey ? this.selEnd = this.cursorPos : e && this._clearSel(), this.movingLeft = !1, this._updateCursor();
      else if (37 === d) {
        if (a.shiftKey) {
    ...
    focus: function(a) {
      ...
      !this.get("focused") && this.cursorPos == b && (this.selStart = b, this.selEnd = 0, e = this.get("selectAllOnFocus"));
      e || this._clearSel();
      this._updateCursor();
      this.inputEl.focus()
    },
    ...
    _updateCursor: function() {
      var a, d = this.get("leftPadding"),
        e = this.get("fieldScroll");
      if (this.hasSel()) {
        var c = this.getDistanceToPos(this.selStart, "cursor"),
          f = this.getDistanceToPos(this.selEnd, "cursor");
        a = this.movingLeft ? Math.min(c, f) : Math.max(c, f);
        ...
        this.selEl.setStyles({
          left: d + Math.min(c, f) + e + "px",
          width: Math.abs(c - f) + "px"
        })
      } else b.Lang.isUndefined(this.cursorPos) && (this.cursorPos = this.length()), a = c = this.getDistanceToPos(this.cursorPos, "cursor"), this.cursorEl.setStyle("left", d + c + "px"), this.selEl && (this.selEl.remove(), this.selEl = null, this.cursorEl.setStyle("display", "block"));
      d = this.targetEl.get("offsetWidth") - 64;
      c = !1;
      if (a + e - 1 > d) {
        for (; a + e - 1 > d;) e -= 60;
        c = !0
      ...
      c && (this.contentEl.setStyle("margin-left", e + "px"), this.cursorEl.setStyle("margin-left", e + "px"));
    ...
    _updateContent: function() {
      ...
      if (0 === a.length) this.contentEl.setContent("&nbsp;");
        ...
        for (e = 0; e < a.length; ++e) if (this.isVariableAt(a, e)) {
          0 < c.length && (d = b.Node.create("<span>" + this.escapeBuffer(c) + "</span>"), this.contentEl.append(d), c = "");
          d = a[e] + a[e + 1];
          var f = this.get("variables")[d];
          f ? (d = b.Node.create('<span class="unbreakable">' + f.title + "</span>"), d.setAttribute("title", f.tip), this.contentEl.append(d)) : c += d;
          e += this.getVariableLengthAt(a, e) - 1
        } else c += a[e];
        0 < c.length && (d = b.Node.create("<span>" + this.escapeBuffer(c) + "</span>"), this.contentEl.append(d))
      }
    },
    insertChars: function(a) {
      var b = this._compressVariables(this.get("value")),
        e = b.substring(0, this.cursorPos),
        b = b.substring(this.cursorPos);
      this.set("value", this._uncompressVariables((e + a + b).replace(RegExp("\\s+", "g"), " ")));
    ...
    isVariableAt: function(a, d) {
      var e;
      if (!("%" != a[d] || d + 1 >= a.length)) return e = this.get("variables")[this.getVariableAt(a, d)], !b.Lang.isUndefined(e)
    },
    ...
    _compressVariables: function(a) {
      ...
      for (c = 0; c < a.length; ++c) {
        if (this.isVariableAt(a, c) && (e = this.getVariableAt(a, c), this.get("variables")[e])) {
          this.varStack.push(e);
          b += "\u0001";
          c += this.getVariableLengthAt(a, c) - 1;
          continue
        }
        b += a[c]
      }
    ...
    _uncompressVariables: function(a) {
      var b = "",
        ...
        c, f;
      c = 0;
      for (f = a.length; c < f; ++c) this.isVariableAt(a, c) && (this.cursorPos -= this.getVariableLengthAt(a, c) - 1), "\u0001" == a[c] ? (b += this.varStack[e], ++e) : b += a[c];
    ...
    deleteChars: function(a, b) {
      if (!(0 > a)) {
        var e = this._compressVariables(this.get("value")),
          c = e.substring(0, a),
          f = e.substring(a, a + b),
          e = e.substring(a + b),
          f = this._varCount(f);
        if (0 < f) for (var h = this._varCount(c); 0 < f;) this.varStack.splice(h, 1), f--;
        this.set("value", this._uncompressVariables(c + e));
    ...
    getDistanceToPos: function(a, d) {
      ...
      this.contentEl.all("span").each(function(k) {
        if (!("cursor" == d && c == a || "px" == d && e.get("offsetWidth") >= a)) if (k.hasClass("unbreakable")) c++, e.append(b.Node.create('<span class="unbreakable">' + k.getContent() + "</span>")), "px" == d && e.get("offsetWidth") >= a && c--;
        else if (k = this.unescapeBuffer(k.getContent()), "cursor" == d) {
          var l = "";
          f = 0;
          for (h = k.length; f < h && !(l += k[f], c++, c == a); ++f);
          "" !== l && e.append(b.Node.create("<span>" + this.escapeBuffer(l) + "</span>"))
        } else {
          l = b.Node.create("<span></span>");
          e.append(l);
          f = 0;
    ...
    _configureToolTip: function() {
      ...
      b.Object.each(this.get("variables"), function(d, e) {
...
YUI.add("squarespace-dialog-fields-generators", function(b) {
  ...
  b.Squarespace.DialogFieldGenerators["multi-frame"] = Class.extend(b.Squarespace.DialogField, {
    ...
    show: function(a) {
      ...
      if (this.activeEl) {
        ...
        e.forEach(this.setInActiveFrame(!1), this);
      ...
      d.a.on("end", function(a, b) {
        for (var d = 0; d < b.fields.length; ++d) {
          var e = this.panel.fields[b.fields[d].name];
    ...
    append: function(a, d, e, c) {
      for (var f in this.config.frames) {
        d = this.config.frames[f];
        var h = b.DB.DIV("frame-wrapper clear");
        e.append(h);
        this.panel._renderFields(a, d.fields, h, c);
        this.frames[f] = this.config.frames[f];
        this.frames[f].el = h;
        this.frames[f].realHeight = h.get("offsetHeight");
        f != this.config.initialFrame ? (h.setStyle("height", "0px"), h.addClass("hidden"), this.frames[f].visible = !1, this.config.frames[f].fields.forEach(this.setInActiveFrame(!1), this)) : (this.activeEl = this.frames[f], this.frames[f].visible = !0, this.config.frames[f].fields.forEach(this.setInActiveFrame(!0),
        this))
      }
    }
  });
  b.Squarespace.DialogFieldGenerators.select = Class.extend(b.Squarespace.DialogField, {
    initialize: function(a, d, e) {
      ...
      var c, f;
      for (f in this.config.options) d[this.config.name] == f && (this.value = f), c || (c = f), this.underlyingControl.append(b.DB.OPTION({
        html: this.config.options[f].title,
        value: f
      }));
      if (b.Lang.isUndefined(this.value) || b.Lang.isNull(this.value) || !this.config.options[this.value]) null != this.config.defaultValue && !b.Lang.isUndefined(this.config.defaultValue) && this.config.options[this.config.defaultValue] ? this.value = this.config.defaultValue : this.value = c;
  ...
  b.Squarespace.DialogFieldGenerators["multi-option"] = Class.extend(b.Squarespace.DialogField, {
    initialize: function(a, d, e) {
      ...
      for (a = 0; a < this.config.options.length; ++a) if (d = this.config.options[a]) {
        if (this.config.multi) {
          e = !1;
          for (var c = 0; c < this.value.length; ++c) if (this.value[c] == d.value) {
            e = !0;
            break
          }
        } else e = d.value == this.value;
        if (!d.disabled || !this.config.hideDisabled && d.disabled) e = b.DB.DIV("multioption-element option-" + d.value + (e ? " active" : "") + (this.config.buttonStyle ? " button" : "") + (this.config.optionStyle ? " " + this.config.optionStyle : "") + (d.optionStyle ? " " + d.optionStyle : "") + (d.disabled ? " disabled" : ""), {
        ...
        }), d.icon && e.setStyle("backgroundImage", "url(" + d.icon + ")"), this.config.height && e.setStyle("height", this.config.height), !d.title && !d.description && e.setStyle("visibility", "hidden"), this.options.push(e), this.remover[d.value] = e, d.value == this.value && (this.activeEl = e), this.config.dragTray && (e.setStyle("cursor", "move"), e.setData(d), e = (new b.DD.Drag({
          node: e
        })).plug(b.Plugin.DDProxy, {
          moveOnEnd: !1,
          hideOnEnd: !1,
          borderStyle: "none"
        }), this.dds.push(e), e.on("drag:start", function(a, d, e) {
          a = a.target.get("node");
          b.one("body").append(a);
          a.addClass("free-block reattached-node");
          this.dds.splice(this.dds.indexOf(d), 1);
          this.panel.close()
        }, this, e, d.value), e.on("drag:end", function(a, d, e) {
          a = b.DD.DDM.activeDrag;
          e = a.get("node");
          a.get("dragNode").transition({
            easing: "ease-out",
            transform: {
              value: !e.placeholder ? "scale(1.04)" : "scale(.6)",
              duration: 0.4
            },
            opacity: {
              value: 0,
        ...
        }, this, e, d.value), this.config.attachDragHandlers(e))
      }
    ...
    onClick: function(a) {
      ...
      if (b) {
        a = b.getData();
        var e = a.value;
        e && (b.hasClass("disabled") ? this.fire("disabled-click", a.value) : (this.panel.fire("multioption-click", b.data().value), this.config.multi ? (b.toggleClass("active"), this.value = [], this.html.all(".multioption-element.active").each(function(a) {
          this.value.push(a.data().value)
        }, this)) : (this.activeEl && this.activeEl.removeClass("active"), b.addClass("active"), this.activeEl = b, this.value = e), this.config.linkFrame && this.panel.getField(this.config.linkFrame).show(this.value), this.panel.fire("datachange", this, a)))
      }
    },
    resize: function() {
    ...
    add: function(a, d, e) {
      ...
      d = b.DB.DIV("multioption-element " + (a == this.value ? "active" : "") + (this.config.buttonStyle ? "button" : ""), {
        html: '<div class="multioption-thumbnail" style="background-image:url(' + d + ')"></div><div class="multioption-title">' + e + "</div>",
  ...
  b.Squarespace.DialogFieldGenerators.text = Class.extend(b.Squarespace.DialogField, {
    ...
    onKeyUp: function(a) {
      if ("url-slug" === this.config.filter || "url-slug-with-slash" == this.config.filter) {
        ...
        var g = this.control._node.selectionStart - (32 == a.keyCode ? 0 : 1);
        e != d && (this.control.set("value", d), this.control._node.selectionStart = g, this.control._node.selectionEnd = g)
      }
    ...
    showTextSuffix: function() {
      var a = null,
        d = 10,
        e = 6;
      "major" == this.config.style && (d = 12, e = 11);
      "title" == this.config.style && (d = 19, e = 10);
      "small" == this.config.style && (e = d = 3);
  ...
  b.Squarespace.DialogFieldGenerators.rating = Class.extend(b.Squarespace.DialogField, {
    ...
    onClick: function(a) {
      ...
      for (var b = 0, e = 0; 11 > e; e++) if (0 < 13 * e - a) {
        b = e;
        break
      }
      this.value = b / 2;
  ...
  b.Squarespace.DialogFieldGenerators["social-accounts"] = Class.extend(b.Squarespace.DialogField, {
    ...
    onClick: function(a) {
      var b = a.target,
        e = b.ancestor(".social-account", !0);
      !b.hasClass("logo") && (!b.hasClass("chooser-button") && this.activeEl) && this.hideChooser(this.activeEl);
      a.halt();
      if (b.hasClass("logo")) this.toggleChooser(e);
      else if (b.hasClass("plus")) this.getCount() >= this.config.maxCount || (this.showChooser(e.insert(this.renderSocialAccount({
        type: this.config.networks[0],
        username: ""
      }), "after").next()), this.panel.fire("datachange",
      this));
      else if (b.hasClass("minus")) e.remove(), 1 > this.getCount() && this.accountContainerEl.append(this.renderSocialAccount({
        type: this.config.networks[0],
        username: ""
      })), this.panel.fire("datachange", this);
        ...
        e.one(".chooser");
        this.clearSocial(b);
        for (var c = this.config.networks, f = 0; f < c.length; f++) a.target.hasClass(c[f]) && (b.addClass(c[f]), e.one(".type").set("text", c[f]));
        this.hideChooser(e);
        this.panel.fire("datachange", this)
      }
    },
    clearSocial: function(a) {
      for (var b = this.config.networks, e = 0; e < b.length; e++) console.log(b[e]), a.removeClass(b[e])
    },
    ...
    showChooser: function(a) {
      ...
      this._subscribe(e, "end", function() {
        var a = this.panel.bodyEl,
          b = d.get("region").bottom,
          e = a.get("region").bottom;
        a.hasClass("scrollable") && b > e && a.set("scrollTop", a.get("scrollHeight"))
      }, this);
      e.run();
    ...
    renderSocialAccount: function(a, d) {
      for (var e = b.DB.DIV("chooser-container"), c = this.config.networks, f = 0; f < c.length; f++) e.append(b.DB.DIV("chooser-button " + c[f]));
      return b.DB.DIV("social-account " + (d ? "hidden" : ""),
      b.DB.DIV("logo " + (a.type ? a.type : ""), b.DB.DIV("chooser", e)), b.DB.DIV("type", {
        html: a.type
      }), b.DB.INPUT("username", {
        value: a.username,
  ...
  b.Squarespace.DialogFieldGenerators["datetime-picker"] = Class.extend(b.Squarespace.DialogFieldGenerators["date-picker"], {
    ...
    _updateTime: function() {
      ...
      10),
        ...
        e = this.ampmControl.get("value");
      if (!isNaN(a) && !isNaN(d)) {
        if (12 < a || 0 >= a) a = 12;
        if (60 < d || 0 > d) d = 0;
        12 == a && "AM" == e ? a = 0 : 12 != a && "PM" == e && (a += 12);
        e = new Date(this.value.getTime());
        a -= b.Lang.trim(b.Squarespace.DateUtils.dateFormat(e, {
          format: "%H"
        }));
        d -= b.Lang.trim(b.Squarespace.DateUtils.dateFormat(e, {
          format: "%M"
        }));
  ...
  b.Squarespace.DialogFieldGenerators.picker = Class.extend(b.Squarespace.DialogField, {
    ...
    renderGroup: function(a, d) {
      b.Array.each(d, function(e) {
        var d = b.DB.DIV("option", {
          data: {
            value: e.value
          }
        }, b.DB.DIV("title", {
          html: e.title
        }), e.description ? b.DB.DIV("description", {
          html: e.description
        }) : null);
        this.registerNode(e.value,
        d);
        a.append(d)
      }, this);
      return a
  ...
  b.Squarespace.DialogFieldGenerators.email = Class.extend(b.Squarespace.DialogFieldGenerators.text, {
    ...
    isValid: function() {
      ...
      b = [this._validateExistence, this._validateFormat], e = !0, c = 0; c < b.length; c++) {
        var f = b[c],
          e = e && f.call(this, a);
        if (!e) break
      }
...
YUI.add("dd-drag", function(b, c) {
    ...
    handles: {
      ...
      setter: function(a) {
        a ? (this._handles = {}, b.Array.each(a, function(a) {
          var e = a;
          if (a instanceof b.Node || a instanceof b.NodeList) e = a._yuid;
          this._handles[e] = a
  ...
  b.extend(d, b.Base, {
    ...
    _handleTarget: function(e) {
      b.DD.Drop && (!1 === e ? this.target && (a._unregTarget(this.target), this.target = null) : (b.Lang.isObject(e) || (e = {}), e.bubbleTargets = e.bubbleTargets || this.getTargets(),
      e.node = this.get("node"), e.groups = e.groups || this.get("groups"), this.target = new b.DD.Drop(e)))
    },
    _groups: null,
    ...
    validClick: function(a) {
      var d = !1,
        ...
        m = c = null,
        l = !1;
      if (this._handles) b.Object.each(this._handles, function(a, c) {
        a instanceof b.Node || a instanceof b.NodeList ? d || (m = a, m instanceof b.Node && (m = new b.NodeList(a._node)), m.each(function(a) {
          a.contains(h) && (d = !0)
        })) : b.Lang.isString(c) && (h.test(c + ", " + c + " *") && !k) && (k = c, d = !0)
      });
      else if (c = this.get("node"), c.contains(h) || c.compareTo(h)) d = !0;
      d && this._invalids && b.Object.each(this._invalids, function(a, c) {
        b.Lang.isString(c) && h.test(c + ", " + c + " *") && (d = !1)
      });
      d && (k ? (c = a.currentTarget.all(k), l = !1, c.each(function(a) {
        if ((a.contains(h) || a.compareTo(h)) && !l) l = !0, this.set("activeHandle", a)
    ...
    _prep: function() {
      this._dragThreshMet = !1;
      var c = this.get("node");
      c.addClass(a.CSS_PREFIX + "-draggable");
      c.on(d.START_EVENT, b.bind(this._handleMouseDownEvent, this));
      c.on("mouseup", b.bind(this._handleMouseUp, this));
      c.on("dragstart", b.bind(this._fixDragStart, this))
    },
    _unprep: function() {
      var b = this.get("node");
  ...
  b.extend(d, b.Base, {
    ...
    sizeShim: function() {
      ...
      var c = this.get("node"),
        ...
        c = c.getXY(),
        h = this.get("padding"),
        k, m, f = f + h.left + h.right,
        d = d + h.top + h.bottom;
      c[0] -= h.left;
      c[1] -= h.top;
      a.activeDrag.get("dragMode") === a.INTERSECT && (h = a.activeDrag, k = h.get("node").get("offsetHeight"),
      m = h.get("node").get("offsetWidth"), d += k, f += m, c[0] -= m - h.deltaXY[0], c[1] -= k - h.deltaXY[1]);
      this.get("useShim") && this.shim.setStyles({
        height: d + "px",
        width: f + "px",
        top: c[1] + "px",
  ...
  b.DataTable.Base = b.Base.create("datatable", b.Widget, [b.DataTable.Core], {
    ...
    _extractDisplayColumns: function(a) {
      function c(a) {
        var f, h, k;
        f = 0;
        for (h = a.length; f < h; ++f) k = a[f], b.Lang.isArray(k.children) ? c(k.children) : e.push(k)
      }
      var e = [];
      c(a);
      this._displayColumns = e
    },
    initializer: function() {
    ...
    renderUI: function() {
      var a = this,
        c = this.get("view");
      c && (this.view = new c(b.merge(this.getAttrs(), {
        host: this,
  ...
  d = {
    ...
    _getConstraint: function() {
      var a = this.get("constrain"),
        c = this.get("gutter"),
        d;
      a && (a instanceof b.Node ? (this._regionCache || (this._eventHandles.push(b.on("resize", b.bind(this._cacheRegion, this), b.config.win)), this._cacheRegion()), d = b.clone(this._regionCache), this.get("cacheRegion") || this.resetCache()) : b.Lang.isObject(a) && (d = b.clone(a)));
      if (!a || !d) a = "view";
      "view" === a && (d = this.get("host").get("dragNode").get("viewportRegion"));
      b.Object.each(c, function(a, b) {
    ...
    drag: function() {
      ...
      if ((b.Lang.isNumber(c) || this.get("tickXArray")) && this._lastTickXFired !== a[0]) this._tickAlignX(), this._lastTickXFired = a[0];
      if ((b.Lang.isNumber(d) || this.get("tickYArray")) && this._lastTickYFired !== a[1]) this._tickAlignY(), this._lastTickYFired = a[1]
    },
    _checkTicks: function(b, c) {
      var d = this.get("host"),
        e = d.startXY[0] - d.deltaXY[0],
        d = d.startXY[1] - d.deltaXY[1],
        m = this.get("tickX"),
        l = this.get("tickY");
      m && !this.get("tickXArray") && (b[0] = a._calcTicks(b[0], e, m, c.left, c.right));
      l && !this.get("tickYArray") && (b[1] = a._calcTicks(b[1], d, l, c.top, c.bottom));
      this.get("tickXArray") && (b[0] = a._calcTickArray(b[0], this.get("tickXArray"), c.left, c.right));
      this.get("tickYArray") && (b[1] = a._calcTickArray(b[1], this.get("tickYArray"), c.top, c.bottom));
      return b
    },
  ...
  b.mix(a, {
    _calcTicks: function(a, b, c, d, e) {
      var l = (a - b) / c,
        p = Math.floor(l),
        n = Math.ceil(l);
      if ((0 !== p || 0 !== n) && l >= p && l <= n) a = b + c * p, d && e && (a < d && (a = b + c * (p + 1)), a > e && (a = b + c * (p - 1)));
      return a
    },
    _calcTickArray: function(a, b, c, d) {
      ...
      if (b[0] >= a) return b[0];
      for (e = 0; e < l; e++) if (p = e + 1, b[p] && b[p] >= a) return n = a - b[e], a = b[p] - a, p = a > n ? b[e] : b[p], c && d && p > d && (p = b[e] ? b[e] : b[l - 1]), p;
      return b[b.length - 1]
    }
  })
}, "3.17.2", {
...
YUI.add("dd-ddm-base", function(b, c) {
  ...
  b.extend(a, b.Base, {
    ...
    getDrag: function(a) {
      var c = !1,
        g = b.one(a);
      g instanceof b.Node && b.Array.each(this._drags, function(a) {
        g.compareTo(a.get("node")) && (c = a)
      });
      return c
    },
    ...
    swapNode: function(a, c) {
      a = b.DD.DDM.getNode(a);
      c = b.DD.DDM.getNode(c);
      var g = c.get("parentNode"),
        f = c.get("nextSibling");
      f === a ? g.insertBefore(a, c) : c === a.get("nextSibling") ? g.insertBefore(c, a) : (a.get("parentNode").replaceChild(c, a), g.insertBefore(a, f));
      return a
    }
  });
  b.namespace("DD");
...
var Kicksend = {
  mailcheck: {
    ...
    findClosestDomain: function(b, c, a) {
      ...
      return e <= this.threshold && null !== g ? g : !1
    },
    sift3Distance: function(b, c) {
      if (null == b || 0 === b.length) return null == c || 0 === c.length ? 0 : c.length;
      if (null == c || 0 === c.length) return b.length;
      for (var a = 0, d = 0, e = 0, g = 0; a + d < b.length && a + e < c.length;) {
        if (b.charAt(a + d) == c.charAt(a + e)) g++;
        else for (var f = e = d = 0; 5 > f; f++) {
          if (a + f < b.length && b.charAt(a + f) == c.charAt(a)) {
            d = f;
            break
          }
          if (a + f < c.length && b.charAt(a) == c.charAt(a + f)) {
            e = f;
            break
          }
        }
  ...
  b.namespace("DataTable").TableView = b.Base.create("table", b.View, [], {
    ...
    _extractDisplayColumns: function() {
      function a(b) {
        var d, e, f;
        d = 0;
        for (e = b.length; d < e; ++d) f = b[d], g(f.children) ? a(f.children) : c.push(f)
      }
