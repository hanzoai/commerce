...
func (o *Organization) BeforeCreate() error {
	...
	// A new record is born in the kind its deployment declares (see Born). It
	// only ever raises: a creator that asked for live keeps it, and nothing here
	// makes a record test that its creator made live.
	if Born == Live {
		o.Live = true
	}
