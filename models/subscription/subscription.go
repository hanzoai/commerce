...
const (
	...
	// External is a plan collected OUTSIDE Hanzo: the customer paid an invoice the
	// processor's own dashboard raised, or a wire. Nothing here invoices it or charges
...
type Subscription struct {
	...
	// Test is set when the subscription was bought in test mode, where a sandbox
	// processor settles test cards and no money moves. It confers its plan only to
	// a test-mode reader, never to a live one.
