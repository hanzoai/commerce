...
func IsReference(claims Claims) bool {
	return claims.Type == Reference && claims.UserId != "" && claims.OrganizationName != "" && claims.AppName == ""
}

func IsRefresh(claims Claims) bool {
	return claims.Type == Refresh && claims.UserId != "" && claims.OrganizationName != "" && claims.AppName == ""
}

func IsAccess(claims Claims) bool {
	return claims.Type == Access && claims.UserId != "" && claims.OrganizationName != "" && claims.AppName == ""
}

// API Based Tokens
func IsApi(claims Claims) bool {
	return claims.Type == Api && claims.UserId == "" && claims.OrganizationName != "" && claims.AppName != ""
}

func IsCustomer(claims Claims) bool {
	return claims.Type == Customer && claims.UserId != "" && claims.OrganizationName != "" && claims.AppName != ""
}
