...
func TestF1_PatchUpgrade_NonMint_Gated(t *testing.T) {
	...
	wantPro, wantTeam := IncludedMonthlyCents("pro"), IncludedMonthlyCents("team")
	if wantPro == wantTeam {
		t.Fatal("pro and team mint the same allotment; this test cannot tell laundering from a no-op")
	}
