...
func sendEmailConfirmation(c *gin.Context, org *organization.Organization, usr *user.User) error {
...
func sendEmailConfirmed(c *gin.Context, org *organization.Organization, usr *user.User) error {
...
func sendWelcome(c *gin.Context, org *organization.Organization, usr *user.User) error {
