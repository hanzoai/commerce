...
class Chart extends View
  ...
  title: ''
  subtitle: ''
  html: '<canvas id="myChart" width="100%" height="400"></canvas>'
  ...
  js: (opts)->
    ...
    @on 'update', ()=>
      @root.children[0].width = $('#content').width() - 80
      @root.children[0].height = 400
      @refresh()

  refresh: ->
    @chart = new ChartJS @root.children[0], @model
